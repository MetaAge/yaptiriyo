...
class AppUrls {
  ...
  static String promoteUrl = '$baseEndPoint/promotion/package/buy';
  ...
  static String moduleListUrl = '$baseEndPoint/module/module-status';
  static String updatePromotionPaymentUrl =
      '$baseEndPoint/promotion/package/update-payment';
  ...
  static String promotionPackagesUrl = '$baseEndPoint/promotion/package/list';
