      ...
      body: CustomRefreshIndicator(
        ...
        child: CustomFutureWidget(
            ...
            child: Consumer<OrderDetailsService>(builder: (context, od, child) {
              ...
              if (od.orderDetailsModel.orderDetails == null) {
                return Column(
                  children: [
                    16.toHeight,
                    Expanded(
                        child:
                            EmptyWidget(title: LocalKeys.orderDetailsNotFound)),
                    16.toHeight,
                  ],
                );
              }
                  ...
                  Container(
                    ...
                    child: MyOrderCardInfos(
                      ...
                      rating: orderDetails.rating?.isEmpty ?? true
                          ? null
                          : (orderDetails.rating?.map((e) {
                                    return e.rating ?? 0;
                                  }).toList() ??
                                  [])
                              .calculateAverage,
                      customerImage: (od.orderDetailsModel.orderDetails?.user
                                      ?.cloudImage ??
                                  "")
                              .isNotEmpty
                          ? od.orderDetailsModel.orderDetails!.user!.cloudImage!
                          : od.orderDetailsModel.imagePath.toString(),
