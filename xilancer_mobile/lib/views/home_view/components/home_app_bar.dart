...
import '../../../view_models/sign_in_view/social_sign_in_view_model.dart';
        ...
        InkWell(
          onTap: () {
            ...
            hdm.setValues(jl.country, jl.experience, jl.length, jl.maxPrice,
                jl.minPrice, jl.category, jl.subCat, jl.jobType);
                    ...
                    child: SizedBox(
                      ...
                      child: ClipRRect(
                        ...
                        child: CachedNetworkImage(
                          fit: BoxFit.cover,
                          imageUrl: (pi.profileInfoModel.data?.cloudImage ?? "")
                                  .isNotEmpty
