      ...
      return Column(
        ...
        children: [
                        ...
                        onPressed: jd.jobDetailsModel.alreadyApplied == true
                            ...
                            : () {
                                ...
                                showModalBottomSheet(
                                  ...
                                  builder: (context) => ApplyJobPlainSheet(
                                      jobType:
                                          jd.jobDetailsModel.jobDetails?.type),
                                );
                              },
                        icon: SvgAssets.send
          ...
          JobDetailsDownloadAttachmentButton(
            attachment: jd.jobDetailsModel.jobDetails?.attachmentCloud ??
                jd.jobDetailsModel.jobDetails?.attachment,
            attachmentPath: jd.jobDetailsModel.attachmentPath,
            isUsingCloud:
                jd.jobDetailsModel.jobDetails?.attachmentCloud != null,
          ),
        ],
      );
    });
