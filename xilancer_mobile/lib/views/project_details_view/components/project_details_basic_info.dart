...
import 'package:xilancer/utils/components/pro_tag.dart';
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            Stack(
              children: [
                SizedBox(
                  ...
                  child: ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      fit: BoxFit.cover,
                      imageUrl: (pd.projectDetailsModel.projectDetails
                                      ?.cloudImage ??
                                  "")
                              .isNotEmpty
                          ? pd.projectDetailsModel.projectDetails!.cloudImage!
                ...
                Row(
                  ...
                  children: [
                    if (pd.projectDetailsModel.projectDetails?.status
                            .toString() ==
                        "0")
                      Container(
            ...
            if (showEdit) ...[20.toHeight, ProjectDetailsButtons(pd: pd)],
          ],
        ),
      );
    });
