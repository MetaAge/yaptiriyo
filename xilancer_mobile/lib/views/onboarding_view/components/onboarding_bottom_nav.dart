  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder(
        ...
        builder: (context, value, child) => Container(
              ...
              child: SizedBox(
                height: context.width > 500 ? 44 : 72,
                child: Row(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        constraints: BoxConstraints(
            minWidth: selected && context.width > 400 ? 110 : 0.0),
        decoration: selected && context.width > 400
            ? BoxDecoration(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          (selected
              ? iconFilled.toSVGSized(context.width < 400 ? 26 : 20,
