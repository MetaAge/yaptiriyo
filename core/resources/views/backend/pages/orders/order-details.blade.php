            ...
            <div class="dashboard__jobFilter responsive-lg">
                <div class="shop-sidebar-content">
                    <div class="shop-close-content radius-10">
                        ...
                        {{-- Physical Service Info --}}
                        <div class="single-shop-left bg-white radius-10 mt-5">
                            <h6 class="user-details-manage-title">
                                <span class="user-details-manage-thumb">
                                    <i class="fa-solid fa-location-dot" style="font-size: 20px; color: var(--main-color-one);"></i>
                                </span>
                                {{ __('Hizmet Teslimat Bilgileri') }}
                            </h6>
                            <div class="user-details-manage-list mt-4">
                                <ul class="user-details-manage-list-item">
                                    <li class="details-list-item">
                                        <span class="details-list-item-label"><strong>{{ __('Randevu Tarihi') }}:</strong></span>
                                        <span class="details-list-item-content">{{ $order_details->appointment_date ? \Carbon\Carbon::parse($order_details->appointment_date)->format('d.m.Y') : '-' }}</span>
                                    </li>
                                    <li class="details-list-item">
                                        <span class="details-list-item-label"><strong>{{ __('Randevu Saati') }}:</strong></span>
                                        <span class="details-list-item-content">{{ $order_details->appointment_time ?? '-' }}</span>
                                    </li>
                                    <li class="details-list-item">
                                        <span class="details-list-item-label"><strong>{{ __('Telefon') }}:</strong></span>
                                        <span class="details-list-item-content">{{ $order_details->phone ?? '-' }}</span>
                                    </li>
                                    <li class="details-list-item">
                                        <span class="details-list-item-label"><strong>{{ __('Şehir / İlçe') }}:</strong></span>
                                        <span class="details-list-item-content">{{ $order_details->city?->city ?? '-' }} / {{ $order_details->state?->state ?? '-' }}</span>
                                    </li>
                                    <li class="details-list-item">
                                        <span class="details-list-item-label"><strong>{{ __('Tam Adres') }}:</strong></span>
                                        <span class="details-list-item-content">{{ $order_details->service_address ?? '-' }}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<div id="hidden-chat-modal" style="display:none;">
...
@section('script')
    ...
    <script>
        $(window).on('load', function () {
            var modalContent = $('#hidden-chat-modal').html();
            $('body').append(modalContent);
            $('#hidden-chat-modal').remove();
        });
    </script>
@endsection
