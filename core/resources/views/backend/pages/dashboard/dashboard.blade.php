                        ...
                        <a href="" class="dashboard__promo__col promo_child">
                            <div class="single_promo">
                                <div class="single_promo__contents">
                                    ...
                                    <h4 class="single_promo__title mt-2"> {{ float_amount_with_currency_symbol($total_revenue ?? 0) }} </h4>
                                </div>
                            </div>
                        </a>
                        <a href="{{ route('admin.order.all') }}" class="dashboard__promo__col promo_child">
                            <div class="single_promo">
                                <div class="single_promo__contents">
                                    ...
                                    <h4 class="single_promo__title mt-2"> {{ float_amount_with_currency_symbol($total_order_revenue ?? 0) }} </h4>
                                </div>
                            </div>
                        </a>
                        <a href="{{ route('admin.user.subscription.all') }}" class="dashboard__promo__col promo_child">
                            <div class="single_promo">
                                <div class="single_promo__contents">
                                    ...
                                    <h4 class="single_promo__title mt-2"> {{ float_amount_with_currency_symbol($total_subscription_revenue ?? 0) }} </h4>
                                </div>
                            </div>
                        </a>
                            ...
                            <a href="" class="dashboard__promo__col promo_child">
                                <div class="single_promo">
                                    <div class="single_promo__contents">
                                        ...
                                        <h4 class="single_promo__title mt-2"> {{ float_amount_with_currency_symbol($total_promotion_revenue ?? 0) }} </h4>
                                    </div>
                                </div>
                            </a>
                        @endif
                        ...
                        <a href="{{ route('admin.freelancer.all') }}" class="dashboard__promo__col promo_child">
                            <div class="single_promo">
                                <div class="single_promo__contents">
                                    ...
                                    <h4 class="single_promo__title mt-2"> {{ $total_freelancer ?? 0 }} </h4>
                                </div>
                            </div>
                        </a>
                        <a href="{{ route('admin.client.all') }}" class="dashboard__promo__col promo_child">
                            <div class="single_promo">
                                <div class="single_promo__contents">
                                    ...
                                    <h4 class="single_promo__title mt-2"> {{ $total_client ?? 0 }}</h4>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="dashboard__maps__footer mt-4">
                        ...
                        <ul class="dashboard__maps__footer__list mt-4">
                            <li class="dashboard__maps__footer__list_item">
                                ...
                                <span class="dashboard__maps__footer__list__count">{{ get_static_option('admin_commission_type') ? ucfirst(get_static_option('admin_commission_type')) : '' }}</span>
                            </li>
                            <li class="dashboard__maps__footer__list_item">
                                <span class="dashboard__maps__footer__list__country">{{ __('Commission Charge') }}</span>
                                <span class="dashboard__maps__footer__list__count">{{ get_static_option('admin_commission_charge') ?? 0 }}</span>
                            </li>
                            <li class="dashboard__maps__footer__list_item">
                                <span class="dashboard__maps__footer__list__country">{{ __('Transaction Fee Type') }}</span>
                                <span class="dashboard__maps__footer__list__count">{{ get_static_option('transaction_fee_type') ? ucfirst(get_static_option('transaction_fee_type')) : '' }}</span>
                            </li>
                            <li class="dashboard__maps__footer__list_item">
                                <span class="dashboard__maps__footer__list__country">{{ __('Transaction Fee Charge') }}</span>
                                <span class="dashboard__maps__footer__list__count">{{ get_static_option('transaction_fee_charge') ?? 0 }}</span>
                            </li>
                            <li class="dashboard__maps__footer__list_item">
                            ...
                            <li class="dashboard__maps__footer__list_item">
                                ...
                                <span class="dashboard__maps__footer__list__count">{{ get_static_option('job_auto_approval') ? ucfirst(get_static_option('job_auto_approval')) : '' }}</span>
                            </li>
                            <li class="dashboard__maps__footer__list_item">
                                <span class="dashboard__maps__footer__list__country">{{ __('Project Auto Approval') }}</span>
                                <span class="dashboard__maps__footer__list__count">{{ get_static_option('project_auto_approval') ? ucfirst(get_static_option('project_auto_approval')) : '' }}</span>
                            </li>
                            @php
                            ...
                            <li class="dashboard__maps__footer__list_item">
                                ...
                                <span class="dashboard__maps__footer__list__count">
                                    @if($withdraw_fee_type === 'percentage')
                                        {{ float_amount_without_currency_symbol($withdraw_fee) }}%
                                    @else
                                        {{ float_amount_with_currency_symbol($withdraw_fee) }}
                                    @endif
                                </span>
                            </li>
                            <li class="dashboard__maps__footer__list_item">
                            ...
                            <li class="dashboard__maps__footer__list_item">
                                <span class="dashboard__maps__footer__list__country">{{ __('Minimum Deposit Amount') }}</span>
                                <span class="dashboard__maps__footer__list__count">{{ float_amount_with_currency_symbol(get_static_option('minimum_deposit_amount') ?? 0) }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="activities-single-table mt-4">
                                <table class="table table-responsive">
                                    ...
                                    @foreach($orders as $order)
                                        <tr>
                                            <td>{{ $order->user_id ?? '' }}</td>
                                            <td>{{ $order->is_project_job ? ucfirst($order->is_project_job) : '' }}</td>
                                            <td>{{ float_amount_with_currency_symbol($order->price ?? 0) }}</td>
                                            <td>
