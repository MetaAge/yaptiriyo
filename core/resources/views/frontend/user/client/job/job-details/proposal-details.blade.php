...
@section('content')
    <main>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h3 class="mb-4">{{ $proposal_details->job->title ?? 'Job Title' }}</h3>
                </div>
            </div>
        </div>
                                                    ...
                                                    <div class="jobFilter-proposal-author-contents-review mt-2">
                                                        ...
                                                        <div class="flex items-center gap-1">
                                                            <div class="rating-stars text-warning">
                                                                @for($i = 1; $i <= 5; $i++)
                                                                    @if($i <= round($freelancerAvgRating))
                                                            ...
                                                            <span class="text-sm font-semibold text-gray-700">{{ number_format($freelancerAvgRating, 1) }}</span>
                                                            <span class="text-sm text-gray-500">({{ $freelancerReviewCount }})</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
