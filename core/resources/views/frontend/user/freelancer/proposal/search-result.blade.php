        ...
        <div class="myOrder-single bg-white padding-20 radius-10">
            ...
            <div class="myOrder-single-item">
                <h4 class="myOrder-single-item-title mb-3">
                    @if($proposal->job && $proposal->job->title)
                        <h4 class="mb-2">
                    ...
                    @else
                        <span class="text-danger" style="font-size: 1.25rem;">{{ __('Job Not Found') }}</span>
                    @endif
                </h4>
            </div>
            ...
            <div class="myOrder-single-item">
                ...
                <p class="mt-4 cover_letter">{{ Str::limit($proposal->cover_letter,250 ?? '')  }}</p>
            </div>
            <div class="myOrder-single-item">
