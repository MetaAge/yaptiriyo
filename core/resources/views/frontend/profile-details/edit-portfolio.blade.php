...
<div class="popup-fixed portfolio_edit_popup">
    <div class="popup-contents">
        ...
        <h5 class="popup-contents-title">{{ __('Edit Portfolio Project') }}</h5>
        ...
        <form action="#" id="edit_portfolio_form">
            ...
            <div class="photo-uploaded mb-4">
                ...
                <span class="font-medium text-base-300 change_image_text">{{ __('Click to change project image') }}</span>
            ...
            <div class="popup-contents-form custom-form">
                <div class="mb-4">
                    <label for="edit_portfolio_title">{{ __('Portfolio Title') }}</label>
                    <input type="text" name="edit_portfolio_title" id="edit_portfolio_title" class="form--control" placeholder="{{ __('Write Project Title') }}">
                ...
                <div class="mb-4">
                    <label for="edit_portfolio_description">{{ __('Project Description') }}</label>
                    <textarea name="edit_portfolio_description" id="edit_portfolio_description" class="form--control" rows="4" placeholder="{{ __('Type Project Details') }}"></textarea>
                    <div class="flex justify-between mt-1">
            ...
            <div class="popup-contents-btn">
                ...
                <button type="submit" class="btn-profile btn-bg-1 edit_portfolio flex-1">{{ __('Update Project') }}</button>
            </div>
        </form>
    </div>
</div>
<!-- Edit Portfolio Popup Ends -->