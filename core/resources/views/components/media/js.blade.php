...
<script>
    (function($) {
            ...
            if (typeof allData != 'undefined') {
                ...
                $.each(allData, function(index, value) {
                    ...
                    mainUploadBtn.parent().find('.img-wrap').append(
                        '<div class="img-inner-wrap"><div class="rmv-span"><i class="{{ $trash_icon }}"></i></div><div class="attachment-preview"><div class="thumbnail"><div class="centered">' +
        ...
        $(document).on('click', '.media_library_image_delete_btn', function(e) {
            ...
            Swal.fire({
                title: '{{ __('Are you sure to delete this media') }}',
                text: '{{ __('This media will remove permanently') }}',
                icon: 'warning',
        ...
        Dropzone.options.placeholderfForm = {
            dictDefaultMessage: "{{ __('Drag or Select Your Image/Video') }}",
            maxFiles: 50,
