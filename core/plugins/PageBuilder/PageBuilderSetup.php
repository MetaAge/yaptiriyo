...
class PageBuilderSetup
{
    private static function register_widgets(): array
    {
        ...
        $addons = [
            ...
            //\plugins\PageBuilder\Addons\Project\SelectedProjectOne::class,
            ...
            \plugins\PageBuilder\Addons\About\OurStory::class,
            ...
            \plugins\PageBuilder\Addons\HireTheBest\HireTheBest::class,
            \plugins\PageBuilder\Addons\HowItWorks\HowItWorks::class,
            ...
            \plugins\PageBuilder\Addons\GetStarted\GetStarted2::class,
        ];
//        return $addons;
