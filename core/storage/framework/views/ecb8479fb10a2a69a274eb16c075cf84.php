    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            function categories(page,string_search){
                $.ajax({
                     url:"<?php echo e(route('admin.subscription.paginate.data').'?page='); ?>" + page,
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.subscription.search')); ?>",
                    method:'GET',
                    data:{string_search:string_search},
                    success:function(res){
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/Modules/Subscription/Resources/views/backend/subscription/subscription-js.blade.php ENDPATH**/ ?>