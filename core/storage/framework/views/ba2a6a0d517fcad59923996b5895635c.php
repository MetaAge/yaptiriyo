    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','.user_details',function(){
                ...
                //edit user info
                let user_type_value = $(this).data('type'); // Get the original numeric value
                $('#edit_user_details #edit_user_id').val(user_id);
                $('#edit_user_details #edit_user_type').val(user_type_value);
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/backend/pages/user/clients/user-js.blade.php ENDPATH**/ ?>