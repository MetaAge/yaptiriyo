<?php if(get_static_option('project_enable_disable') != 'disable'): ?>
    <!-- Trending Services -->
    <section class="relative" style="background-color:<?php echo e($section_bg ?? ''); ?>">
        <div class="container mx-auto max-w-7xl px-4 sm:px-6 py-10 md:py-16 lg:py-28 relative">
            <!-- Section Title -->
            <h2 class="mb-10 text-4xl text-gray-800 font-medium text-center lg:text-left">
                <?php echo e($title ?? __('Trending Services')); ?>
            ...
            <div class="relative px-0">
                <!-- Arrow left -->
                <button title="<?php echo e(__('Previous')); ?>" id="projectPrevBtn"
                        class="absolute -left-4 top-1/2 transform -translate-y-1/2 z-20 w-10 h-10 bg-secondary rounded-full shadow-lg hover:bg-secondary/90 transition-all duration-300 flex items-center justify-center opacity-0 invisible">
                    <i class="fa-solid fa-arrow-left text-white"></i>
                </button>

                <!-- Arrow right -->
                <button title="<?php echo e(__('Next')); ?>" id="projectNextBtn"
                        class="absolute -right-4 top-1/2 transform -translate-y-1/2 z-20 w-10 h-10 bg-secondary rounded-full shadow-lg hover:bg-secondary/90 transition-all duration-300 flex items-center justify-center opacity-0 invisible">
                    <i class="fa-solid fa-arrow-right text-white"></i>
                </button>

                <!-- Carousel Container -->
                <div class="outer-carousel-container overflow-hidden">
                    <div id="trendingCards" class="outer-carousel-track flex gap-6 transition-transform duration-500 ease-in-out">
                        <?php $__currentLoopData = $top_projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                ...
                                $categoryName = $categories[$project->category_id] ?? __('General');
                                $ratingData = $projectRatings[$project->id] ?? ['average' => '0.0', 'count' => 0];
                            ...
                            ?>
                                    ...
                                    <!-- Project Card -->
                            <div class="service-card bg-white rounded-2xl border max-w-[395px] flex-shrink-0 overflow-hidden">
                                <figure class="relative w-full px-4 pt-4">
                                    ...
                                    ?>
                                            ...
                                            <!-- Favorite button - Using the bookmark component -->
                                    <?php if(Auth::guard('web')->check()): ?>
                                        <?php
                                            // Check if this project is bookmarked by the current user
                                        ...
                                        <?php if($bookmark_exists): ?>
                                            ...
                                            <button type="button"
                                                    ...
                                                    class="absolute top-6 right-6 p-2 bg-white rounded-full hover:text-red-500 transition-colors z-20 project-bookmark-btn"
                                                    ...
                                                    onclick="projectBookmarkHandler.toggleBookmark(event, this)"
                                    ...
                                    <?php else: ?>
                                        ...
                                        <button type="button"
                                                ...
                                                class="absolute top-6 right-6 p-2 bg-white rounded-full hover:text-red-500 transition-colors z-20 project-bookmark-btn"
                                                onclick="projectBookmarkHandler.loginRequired(event)"
                                                style="pointer-events: auto;">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                 stroke-width="1.5" stroke="currentColor" class="w-6 h-6"
                                                 style="pointer-events: none;">
        ...
        <?php echo e(get_static_option('promoted_badge_text', 'Sponsored')); ?>
                                    ...
                                    <div class="card-image-carousel relative w-full rounded-lg overflow-hidden">
                                        <?php if($mediaCount > 0): ?>
                                            ...
                                            <?php if($hasMultipleMedia): ?>
                                                <button class="card-arrow-btn card-left-arrow absolute left-2 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white p-2 rounded-full shadow-lg transition-all duration-300 hidden">
                                                ...
                                                <button class="card-arrow-btn card-right-arrow absolute right-2 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white p-2 rounded-full shadow-lg transition-all duration-300">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5 text-gray-800">
                                                ...
                                                <div class="card-pagination-container">
                                                    <?php $__currentLoopData = $projectMedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dotIndex => $mediaFile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <button class="card-pagination-dot w-2 h-2 rounded-full transition-all <?php echo e($dotIndex === 0 ? 'active' : ''); ?>"
                                        ...
                                        <?php else: ?>
                                            ...
                                            <div class="w-full h-full flex items-center justify-center bg-gray-100">
                                                <div class="text-center">
                                                    ...
                                                    <span class="text-gray-400 text-sm"><?php echo e(__('No Image')); ?></span>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <div class="p-4 space-y-3">
                                    <hgroup class="space-y-3">
                                        ...
                                        <a href="<?php echo e(route('project.details', ['username' => $project->project_creator?->username, 'slug' => $project->slug])); ?>">
                                            <h2 class="text-xl font-medium leading-tight text-base-300 line-clamp-2 hover:underline">
                                    ...
                                    <div class="flex items-center gap-1 text-yellow-500">
                                        ...
                                        <span class="text-sm font-semibold text-gray-700"><?php echo e($averageRating); ?></span>
                                        <span class="text-sm text-gray-500">(<?php echo e($ratingCount); ?> <?php echo e(__('Reviews')); ?>)</span>
                                    </div>
                                        ...
                                        <div class="flex items-center gap-3">
                                            <div class="relative w-10 h-10">
                                                <?php if($project->project_creator?->image): ?>
                                                    <?php if(cloudStorageExist() && in_array(Storage::getDefaultDriver(), ['s3', 'cloudFlareR2', 'wasabi'])): ?>
                                                        <img src="<?php echo e(render_frontend_cloud_image_if_module_exists( 'profile/'. $project->project_creator->image, load_from: $project->project_creator->load_from)); ?>" alt="<?php echo e($project->project_creator->first_name); ?>" class="w-full h-full rounded-full object-cover border-2 border-white shadow">
                                                    <?php else: ?>
                                                        <img src="<?php echo e(asset('assets/uploads/profile/' . $project->project_creator->image)); ?>" alt="<?php echo e($project->project_creator->first_name); ?>" class="w-full h-full rounded-full object-cover border-2 border-white shadow">
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                    <img src="<?php echo e(asset('assets/static/img/author/author.jpg')); ?>" alt="<?php echo e(__('AuthorImg')); ?>" class="w-full h-full rounded-full object-cover border-2 border-white shadow">
                                                <?php endif; ?>
                                            ...
                                            <span class="text-sm font-semibold text-gray-700"><?php echo e($project->project_creator?->full_name ?? __('Unknown')); ?></span>
                                        </div>
        ...
        <style>
            /* Video Styling for Trending Services */
    ...
    <script>
        // Project Bookmark Handler
        window.projectBookmarkHandler = {
            isProcessing: false,
            ...
            toggleBookmark: function(event, button) {
                ...
                console.log('=== PROJECT BOOKMARK TOGGLE ===');
        ...
        // Initialize trending services video players
        document.addEventListener('DOMContentLoaded', function() {
            initializeTrendingVideoPlayers();
        });

        function initializeTrendingVideoPlayers() {
...
<?php endif; ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/app/Providers/../../plugins/PageBuilder/views/projects/latest-project.blade.php ENDPATH**/ ?>