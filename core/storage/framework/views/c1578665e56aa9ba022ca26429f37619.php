...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.notice.general-notice','data' => ['description' => __('Notice: A subscription can be deleted if it has no dependencies. Specifically, it can be removed only if it is not associated with any user.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Notice: A subscription can be deleted if it has no dependencies. Specifically, it can be removed only if it is not associated with any user.'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title"><?php echo e(__('All Subscription')); ?></h4>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('subscription-add')): ?>
                            <a href="<?php echo e(route('admin.subscription.add')); ?>"
                               class="btn btn-primary btn-md d-flex align-items-center">
                                <span class="btn_plus_icon me-1"><i class="fa-solid fa-plus"></i></span>
                                <?php echo e(__('Add New Subscription')); ?>

                            </a>
                            <?php endif; ?>
                        </div>
                        <div class="search_delete_wrapper">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('subscription-bulk-delete')): ?>
...
<?php endif; ?>
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            ...
                            <div class="custom_table style-04 search_result">
                                <?php echo $__env->make('subscription::backend.subscription.search-result', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                            <!-- Table End -->
                        </div>
                    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bulk-action.bulk-delete-js','data' => ['url' => route('admin.subscription.delete.bulk.action')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.subscription.delete.bulk.action'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('backend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/Modules/Subscription/Resources/views/backend/subscription/all-subscription.blade.php ENDPATH**/ ?>