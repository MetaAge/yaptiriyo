    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','.edit_type_modal',function(){
                ...
                let isFree = $(this).data('is_free');
                

                $('#type_id').val(id);
                $('#edit_type').val(type);
                $('#edit_validity').val(validity);
                $('#edit_is_free').prop('checked', isFree == 1);
            });
            ...
            function types(page,string_search){
                $.ajax({
                     url:"<?php echo e(route('admin.subscription.type.paginate.data').'?page='); ?>" + page,
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.subscription.type.search')); ?>",
                    method:'GET',
                    data:{string_search:string_search},
                    success:function(res){
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/Modules/Subscription/Resources/views/backend/type/type-js.blade.php ENDPATH**/ ?>