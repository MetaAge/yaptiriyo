    ...
    <nav id="mainNav" class="border-b border-gray-200 shadow-sm fixed top-0 left-0 right-0 z-[1000] overflow-visible transition-all duration-300">
        <div class="container mx-auto max-w-8xl flex items-center justify-between px-6 py-4">
            ...
            <div id="navbarLogo">
                <a href="<?php echo e(route('homepage')); ?>">
                    <?php if(!empty(get_static_option('site_white_logo'))): ?>
                        <?php echo render_image_markup_by_attachment_id(get_static_option('site_white_logo'), 'w-[157px] site-white-logo hidden'); ?>

                    <?php endif; ?>
                    <?php if(!empty(get_static_option('site_logo'))): ?>
                        <?php echo render_image_markup_by_attachment_id(get_static_option('site_logo'), 'w-[157px] site-dark-logo'); ?>

                    <?php else: ?>
                        <img src="<?php echo e(asset('assets/static/img/logo/logo.png')); ?>" alt="site-logo" class="w-[157px] site-dark-logo">
                    <?php endif; ?>
                </a>
            </div>
            ...
            <div class="hidden lg:flex items-center space-x-3">
                <?php if (isset($component)) { $__componentOriginal8b9c10bb18edfb54dd979a8c529c5cfd = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8b9c10bb18edfb54dd979a8c529c5cfd = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.user-menu-variant-04','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('frontend.user-menu-variant-04'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal8b9c10bb18edfb54dd979a8c529c5cfd)): ?>
<?php $attributes = $__attributesOriginal8b9c10bb18edfb54dd979a8c529c5cfd; ?>
<?php unset($__attributesOriginal8b9c10bb18edfb54dd979a8c529c5cfd); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal8b9c10bb18edfb54dd979a8c529c5cfd)): ?>
<?php $component = $__componentOriginal8b9c10bb18edfb54dd979a8c529c5cfd; ?>
<?php unset($__componentOriginal8b9c10bb18edfb54dd979a8c529c5cfd); ?>
<?php endif; ?>
            </div>
            ...
            <div id="mobileMenuArea" class="hidden absolute inset-0 z-[9999]">
                ...
                <div id="mobileMenuDropdown" class="lg:hidden fixed top-0 bottom-0 left-0 w-72 bg-white shadow-xl px-8 py-6 overflow-y-auto custom-scrollbar z-[999999] transform -translate-x-full transition-transform duration-300 min-h-screen">
                    <div class="flex items-center justify-between">
                        <!-- Mobile Logo -->
                        <a href="<?php echo e(route('homepage')); ?>" class="mb-6">
                            <?php if(!empty(get_static_option('site_logo'))): ?>
                                <?php echo render_image_markup_by_attachment_id(get_static_option('site_logo'), 'w-[120px]'); ?>

                            <?php else: ?>
                                <img src="<?php echo e(asset('assets/static/img/logo/logo.png')); ?>" alt="site-logo" class="w-[120px]">
                            <?php endif; ?>
                        </a>
                        <!-- Close Button -->
                    ...
                    <div class="flex flex-col gap-4 items-start mt-6 w-full">
                        <?php if (isset($component)) { $__componentOriginal7d1a989fb40ca4c63b5271ce560d8f67 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7d1a989fb40ca4c63b5271ce560d8f67 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.user-menu-mobile-variant-04','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('frontend.user-menu-mobile-variant-04'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal7d1a989fb40ca4c63b5271ce560d8f67)): ?>
<?php $attributes = $__attributesOriginal7d1a989fb40ca4c63b5271ce560d8f67; ?>
<?php unset($__attributesOriginal7d1a989fb40ca4c63b5271ce560d8f67); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal7d1a989fb40ca4c63b5271ce560d8f67)): ?>
<?php $component = $__componentOriginal7d1a989fb40ca4c63b5271ce560d8f67; ?>
<?php unset($__componentOriginal7d1a989fb40ca4c63b5271ce560d8f67); ?>
<?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <div id="menuData" style="display: none;">
            <?php echo render_frontend_menu($primary_menu ?? get_static_option('site_primary_menu')); ?>
...
</script><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/layout/partials/navbar-variant/navbar-04.blade.php ENDPATH**/ ?>