...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['identity', 'type', 'btnClass' => 'absolute top-6 right-6 p-2 bg-white rounded-full hover:text-red-500 transition-colors z-20']));
...
foreach (array_filter((['identity', 'type', 'btnClass' => 'absolute top-6 right-6 p-2 bg-white rounded-full hover:text-red-500 transition-colors z-20']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php if(Auth::guard('web')->check()): ?>
    ...
    <?php if($bookmark_exists): ?>
        ...
        <button type="button"
                ...
                class="<?php echo e($btnClass); ?> remove_from_bookmark bookmark-btn"
                data-bookmark-id="<?php echo e($bookmark_exists->id); ?>"
                data-identity="<?php echo e($identity); ?>"
    ...
    <?php else: ?>
        ...
        <button type="button"
                ...
                class="<?php echo e($btnClass); ?> add_to_bookmark bookmark-btn"
                data-identity="<?php echo e($identity); ?>"
                data-type="<?php echo e($type); ?>"
                data-add-route="<?php echo e($add_route); ?>"
                data-remove-route="<?php echo e($remove_route); ?>"
...
<?php else: ?>
    ...
    <button type="button"
            ...
            class="<?php echo e($btnClass); ?> bookmark-login-required bookmark-btn"
            data-identity="<?php echo e($identity); ?>"
            data-type="<?php echo e($type); ?>"
...
<?php if (! $__env->hasRenderedOnce('42cb0568-6d02-4ece-9db2-0ca1da8e20d8')): $__env->markAsRenderedOnce('42cb0568-6d02-4ece-9db2-0ca1da8e20d8'); ?>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/components/frontend/bookmark2.blade.php ENDPATH**/ ?>