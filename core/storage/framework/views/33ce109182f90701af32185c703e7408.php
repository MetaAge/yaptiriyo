<?php $__env->startSection('title', __('Subscription Connect Settings')); ?>
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title"><?php echo e(__('Subscription Connect Settings')); ?></h4>
                        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.notice.general-notice','data' => ['class' => 'mt-5','description' => __('Notice: Connect Settings refers to the number of connects deducted for each bid or job proposal. By default, one connect is automatically reduced unless connect is specified.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('mt-5'),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Notice: Connect Settings refers to the number of connects deducted for each bid or job proposal. By default, one connect is automatically reduced unless connect is specified.'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            <form action="<?php echo e(route('admin.subscription.limit.settings')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.number','data' => ['title' => __('Connect Settings'),'min' => '1','max' => '10','name' => 'limit_settings','value' => get_static_option('limit_settings') ?? '' ,'placeholder' => __('Limit Settings')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Connect Settings')),'min' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('1'),'max' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('10'),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('limit_settings'),'value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(get_static_option('limit_settings') ?? '' ),'placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Limit Settings'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('subscription-connect-settings-update')): ?>
...
<?php echo $__env->make('backend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/Modules/Subscription/Resources/views/backend/settings/limit-settings.blade.php ENDPATH**/ ?>