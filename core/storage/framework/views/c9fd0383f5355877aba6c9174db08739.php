<?php $__env->startSection('title', __('Subscription Expire Settings')); ?>
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title"><?php echo e(__('Subscription Expire Settings')); ?></h4>
                        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.notice.general-notice','data' => ['class' => 'mt-5','description' => __('Notice: How many days in advance would you like to receive a subscription expiry reminder?')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('mt-5'),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Notice: How many days in advance would you like to receive a subscription expiry reminder?'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            <form action="<?php echo e(route('admin.subscription.expire.enable.disable.settings')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="single-input my-5">
                                    <label class="label-title"><?php echo e(__('Enable/Disable Subscription')); ?></label>
                                    <select name="subscription_expire_days" class="form-control">
                                        <option value=""><?php echo e(__('Select Day')); ?></option>
                                        <option value="1" <?php if(get_static_option('subscription_expire_days') == '1'): ?> selected <?php endif; ?>><?php echo e(__('1 Days')); ?></option>
                                        <option value="2" <?php if(get_static_option('subscription_expire_days') == '2'): ?> selected <?php endif; ?>><?php echo e(__('2 Days')); ?></option>
                                        <option value="3" <?php if(get_static_option('subscription_expire_days') == '3'): ?> selected <?php endif; ?>><?php echo e(__('3 Days')); ?></option>
                                        <option value="7" <?php if(get_static_option('subscription_expire_days') == '7'): ?> selected <?php endif; ?>><?php echo e(__('7 Days')); ?></option>
                                    </select>
                                </div>
...
<?php echo $__env->make('backend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/Modules/Subscription/Resources/views/backend/settings/subscription-expire-settings.blade.php ENDPATH**/ ?>