...
class User extends Authenticatable
{
     ...
     */
    public function completed_orders(): \Illuminate\Database\Eloquent\Relations\HasMany
    {
        return $this->hasMany(\App\Models\Order::class, 'freelancer_id', 'id')->where('status', 3);
    }
    ...
    {
        return $this->hasMany(UserServiceArea::class);
    }
}
