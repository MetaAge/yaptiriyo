        ...
        return [
            ...
            'data' => [
                ...
                'statistics' => [
                    ...
                    'total_reviews' => (int) $this->ratings_count > 0 
                        ? (int) $this->ratings_count 
                        : (int) ($this->project_creator->freelancer_ratings_count ?? 0),
                    'average_rating' => $this->ratings_avg_rating 
                        ? round((float) $this->ratings_avg_rating, 2) 
                        : ($this->project_creator->freelancer_ratings_avg_rating ? round((float) $this->project_creator->freelancer_ratings_avg_rating, 2) : null),
                ],
                ...
                'service_areas' => ($this->service_areas ?? collect())->map(function ($area) {
                    return [
                        'id' => $area->id,
