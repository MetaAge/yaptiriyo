...
class WalletController extends Controller
{
    ...
    public function deposit(Request $request)
    {
        ...
        if ($request->selected_payment_gateway === 'manual_payment') {
            ...
            $callbackUrl = url('/api/v1/freelancer/iyzico/3ds-callback-web?order_id=' . $deposit->id . '&type=wallet&register_card=' . ($request->register_card ? 1 : 0));
            
            $threedsResult = $iyzicoService->initialize3DS($deposit, $user, $cardData, $callbackUrl);
            ...
            $paymentResult = $iyzicoService->processPayment($deposit, $user, $cardData);
