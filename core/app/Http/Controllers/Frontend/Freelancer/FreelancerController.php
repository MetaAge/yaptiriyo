...
use App\Models\User;
use App\Models\UserServiceArea;
    ...
    public function edit_profile(Request $request)
    {
        ...
        if($request->ajax()){
            ...
            if ($request->has('service_areas')) {
                UserServiceArea::where('user_id', Auth::guard('web')->user()->id)->delete();
                foreach ($request->service_areas as $area_id) {
                    UserServiceArea::create([
    ...
    public function identity_verification(Request $request)
    {
        ...
        if($request->isMethod('post')){
            ...
            $request->validate([
                ...
                'front_image' => 'required|image|mimes:jpeg,png,jpg|max:5120|dimensions:max_width=2000,max_height=2000',
                'back_image'  => 'required|image|mimes:jpeg,png,jpg|max:5120|dimensions:max_width=2000,max_height=2000',
            ],[
