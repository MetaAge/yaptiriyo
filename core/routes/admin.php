    ...
    Route::group(['middleware' => ['auth:admin','setlang']],function(){
        ...
        Route::controller(JobController::class)->group(function () {
            Route::group(['prefix'=>'job'],function(){
                ...
                Route::match(['get','post'],'country-restriction-settings','country_restriction_settings')->name('job.country.restriction.settings');
        ...
        Route::group(['prefix' => 'user'],function(){
            Route::controller(UserManageController::class)->group(function () {
                ...
                Route::post('bulk-permanent-delete', 'bulk_permanent_delete')->name('user.permanent.delete.bulk.action')->permission('user-permanent-delete');
        ...
        Route::group(['prefix' => 'additional-settings'],function(){
            Route::controller(AdditionalSettingsController::class)->group(function () {
                ...
                Route::match(['get','post'],'user-earning-toggle/settings','freelancer_earning')->name('user.earning.toggle.settings');
                
            });

            // Banner Settings
            Route::controller(\App\Http\Controllers\Backend\BannerSettingsController::class)->group(function () {
                Route::match(['get','post'],'banner/settings','mobile_app_banner_settings')->name('mobile.app.banner.settings');
                Route::post('banner/edit', 'edit_banner')->name('mobile.app.banner.edit');
                Route::post('banner/delete/{id}', 'delete_banner')->name('mobile.app.banner.delete');
                Route::post('banner/bulk-action', 'bulk_action')->name('mobile.app.banner.bulk.action');
                Route::post('banner/project-by-category', 'get_projects_by_category')->name('mobile.app.banner.project.by.category');
            });
        });
