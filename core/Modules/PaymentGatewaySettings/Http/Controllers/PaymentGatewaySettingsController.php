    ...
    public function payment_gateway(Request $request)
    {
        if($request->isMethod('post')){
            $field_rules = [
                ...
                'stripe_connect_client_id' => 'nullable|string|max:191',
                'stripe_webhook_secret_main_account' => 'nullable|string|max:191',
                'stripe_webhook_secret_connected_account' => 'nullable|string|max:191',
                ...
                // xendit
                'xendit_gateway' => 'nullable|string|max:255',
                'xendit_test_mode' => 'nullable|string|max:255',
                'xendit_secret_key' => 'nullable|string|max:255',
                'xendit_webhook_token' => 'nullable|string|max:255',
                'xendit_preview_logo' => 'nullable|string|max:255',
                ...
                //airwallex
                'airwallex_gateway' => 'nullable|string|max:255',
                'airwallex_test_mode' => 'nullable|string|max:255',
                'airwallex_client_id' => 'nullable|string|max:255',
                'airwallex_api_key' => 'nullable|string|max:255',
                'airwallex_api_url' => 'nullable|string|max:255',
                'airwallex_preview_logo' => 'nullable|string|max:255',

                //cryptomus
                'cryptomus_gateway' => 'nullable|string|max:255',
                'cryptomus_test_mode' => 'nullable|string|max:255',
                'cryptomus_api_key' => 'nullable|string|max:255',
                'cryptomus_merchant_id' => 'nullable|string|max:255',
                'cryptomus_preview_logo' => 'nullable|string|max:255',
