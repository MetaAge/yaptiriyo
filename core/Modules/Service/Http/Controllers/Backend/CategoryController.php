...
class CategoryController extends Controller
{
    ...
    public function empty_category_settings(Request $request)
    {
        if($request->isMethod('post')){
            $request->validate([
                'hide_empty_categories' => 'nullable|string'
            ]);
            
            update_static_option('hide_empty_categories', $request->hide_empty_categories);
            
            toastr_success(__('Empty Category Settings Updated Successfully.'));
            return back();
        }
        
        return view('service::settings.empty-category-settings');
    }
}
