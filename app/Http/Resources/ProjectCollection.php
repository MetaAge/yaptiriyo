            ...
            'data' => $this->collection->map(function ($project) {
                ...
                return [
                    ...
                    'statistics' => [
                        ...
                        'total_reviews' => (int) ($project->ratings_count ?? 0) > 0 
                            ? (int) $project->ratings_count 
                            : (int) ($project->project_creator->freelancer_ratings_count ?? 0),
                        'average_rating' => $project->ratings_avg_rating 
                            ? round((float) $project->ratings_avg_rating, 2) 
                            : ($project->project_creator->freelancer_ratings_avg_rating ? round((float) $project->project_creator->freelancer_ratings_avg_rating, 2) : null),
                    ],
