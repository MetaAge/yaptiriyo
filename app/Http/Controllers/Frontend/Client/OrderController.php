    ...
    public function order_details(Request $request,$id)
    {
        ...
        $order_details = Order::with([
            'freelancer' => function($q) {
                $q->select('id','first_name','last_name','email','phone','country_id','state_id','city_id','image','username','user_verified_status')
                ->withAvg(['freelancer_ratings as freelancer_ratings_avg_rating' => function ($query) {
        ...
        if($find_login_user_order){
            if($request->isMethod('post')){
                ...
                $rating = Rating::where('order_id',$find_login_user_order->id)
                    ->where('sender_id',$find_login_user_order->user_id)
                ...
                if($rating){
                    ...
                    return redirect()->route('client.order.all')->with(toastr_success( __('Rating successfully submitted.')));
                }
            }
