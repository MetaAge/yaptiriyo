    ...
    public function upload_media_file(Request $request)
    {
        $this->validate($request, [
            'file' => [
                'nullable',
                'file',
                'mimetypes:image/jpeg,image/jpg,image/png,image/gif,image/svg+xml,video/mp4,video/quicktime,video/x-msvideo,video/webm,video/ogg'
            ],
        ], [
            'file.max' => 'The file size exceeds the maximum allowed size of. Please upload a smaller file or contact your administrator to increase the upload limit.',
            'file.mimetypes' => 'Only images (jpg, jpeg, png, gif, svg) and videos (mp4, mov, avi, webm, ogg) are allowed.'
        ]);
