    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            document.querySelector('#front_image').addEventListener('change', function() {
                ...
                $(".identity_verify_front").find('p').first().text("<?php echo e(__('Click to change photo')); ?>")
            ...
            document.querySelector('#back_image').addEventListener('change', function() {
                ...
                $(".identity_verify_back").find('p').last().text("<?php echo e(__('Click to change photo')); ?>")
                if (this.files && this.files[0]) {
            ...
            $(document).on('submit','#submit_freelancer_verify_info',function(e){
                ...
                if(country == '' || address == '' || national_id_number == '' || front_image == '' || back_image == ''){
                    ...
                    $.ajax({
                        url:"<?php echo e(route('freelancer.identity.verification')); ?>",
                        method:'post',
                        ...
                        success:function(res){
                            ...
                            $('.verification_load_spinner').html('Submit');
                            if(res.status=='success'){
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/freelancer/identity/verification-js.blade.php ENDPATH**/ ?>