...
<?php if(request()->has('debug_project')): ?>
    <div class="alert alert-info">
        Title: <?php echo e($project_details->title); ?> <br>
        Description: <?php echo e($project_details->description); ?> <br>
        Attributes: <?php echo e(json_encode($project_details->getAttributes())); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.country-dropdown','data' => ['title' => __('Service Country'),'name' => 'country_id','id' => 'country_id','class' => 'form-control country_select2','selected' => $project_details->country_id]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Service Country')),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('country_id'),'id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('country_id'),'class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('form-control country_select2'),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($project_details->country_id)]); ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-4">
                        <div class="single-input">
                            <label class="label-title"><?php echo e(__('Service State/Province')); ?></label>
                            <select name="state_id" id="state_id" class="form-control state_select2 get_state_city">
                                <option value=""><?php echo e(__('Select State')); ?></option>
                                <?php if($project_details->country_id): ?>
                                    <?php $__currentLoopData = \Modules\CountryManage\Entities\State::where('country_id', $project_details->country_id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($state->id); ?>" <?php if($project_details->state_id == $state->id): echo 'selected'; endif; ?>><?php echo e($state->state); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="single-input">
                            <label class="label-title"><?php echo e(__('Service City/District')); ?></label>
                            <select name="city_id" id="city_id" class="form-control city_select2">
                                <option value=""><?php echo e(__('Select City')); ?></option>
                                <?php if($project_details->state_id): ?>
                                    <?php $__currentLoopData = \Modules\CountryManage\Entities\City::where('state_id', $project_details->state_id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($city->id); ?>" <?php if($project_details->city_id == $city->id): echo 'selected'; endif; ?>><?php echo e($city->city); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
                        </div>
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/freelancer/project/edit/project-introduction.blade.php ENDPATH**/ ?>