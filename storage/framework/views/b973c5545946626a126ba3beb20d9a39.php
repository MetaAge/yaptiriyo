<?php $__env->startSection('site_title', $skill->skill ?? __('Skill Jobs')); ?>
<?php $__env->startSection('meta_title'); ?><?php echo e($skill->skill ?? __('Skill Jobs')); ?><?php $__env->stopSection(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb.user-profile-breadcrumb-02','data' => ['innerTitle' => $skill->skill ?? __('Skill Jobs')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['innerTitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($skill->skill ?? __('Skill Jobs'))]); ?>
...
<?php endif; ?>
        ...
        <section class="bg-[#F8F9FD]">
            <div class="max-w-7xl mx-auto px-6 py-8 md:py-12 lg:py-16">
                <div class="mb-8">
                    <h1 class="text-3xl font-medium mb-2"><?php echo e($skill->skill ?? __('Skill Jobs')); ?></h1>
                    <p class="text-gray-600"><?php echo e(__('Browse all available freelance projects for this skill')); ?></p>
                </div>
                ...
                <div class="search_job_result">
                    <?php echo $__env->make('frontend.pages.skill-jobs.search-job-result', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>

                <!-- Sidebar Filter -->
                <?php echo $__env->make('frontend.pages.skill-jobs.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </section>
    </main>
...
<?php $__env->startPush('page_scripts'); ?>
    <script>
        window.routes = {
            ...
            skillJobsFilter: "<?php echo e(route('skill.jobs.filter')); ?>",
            skillJobsPagination: "<?php echo e(route('skill.jobs.pagination')); ?>",
            skillJobsFilterReset: "<?php echo e(route('skill.jobs.filter.reset')); ?>"
        };
        window.csrfToken = "<?php echo e(csrf_token()); ?>";
        window.skillId = "<?php echo e($skill->id ?? ''); ?>";

        console.log('Route URLs:', window.routes);
        console.log('Skill ID:', window.skillId);
    </script>

    <?php echo $__env->make('frontend.pages.skill-jobs.jobs-filter-js', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.new_design.layout.new_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/skill-jobs/jobs.blade.php ENDPATH**/ ?>