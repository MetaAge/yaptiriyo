<?php $__env->startSection('site_title','Hizmetler'); ?>
<?php $__env->startSection('meta_title'); ?>Hizmetler@endsection
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb.user-profile-breadcrumb-02','data' => ['innerTitle' => 'Tüm Hizmetler']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['innerTitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Tüm Hizmetler')]); ?>
        ...
        <section class="bg-[#F8F9FD]">
            <div class="max-w-7xl mx-auto px-6 py-8 md:py-12 lg:py-16">
                ...
                <div class="search_project_result">
                    <?php echo $__env->make('frontend.pages.projects.search-result', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
                ...
                <!-- Sidebar Filter -->
                <?php echo $__env->make('frontend.pages.projects.sidebar', ['maxProjectPrice' => $maxProjectPrice], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </section>
...
<?php $__env->startPush('page_scripts'); ?>
    ...
    <?php echo $__env->make('frontend.pages.projects.project-filter-js', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopPush(); ?>


<?php echo $__env->make('frontend.new_design.layout.new_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/projects/projects.blade.php ENDPATH**/ ?>