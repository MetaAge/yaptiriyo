<?php $__env->startSection('meta_title'); ?> <?php echo e($subcategory->meta_title ?? $subcategory->sub_category ??  __('Subcategory Jobs')); ?> <?php $__env->stopSection(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb.user-profile-breadcrumb','data' => ['title' => __('Subcategory Jobs') ?? __('Jobs'),'innerTitle' =>  $subcategory->sub_category ?? '' ]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                    ...
                    <div class="col-lg-12">
                        <div class="categoryWrap-wrapper">
                            <div class="shop-contents-wrapper responsive-lg">
                                ...
                                <?php echo $__env->make('frontend.pages.subcategory-jobs.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                ...
                                <div class="shop-contents-wrapper-right">
                                    <div class="jobFilter-wrapper-search">
                                        ...
                                        <button class="jobFilter-wrapper-search-btn" id="job_search_by_text"> <?php echo e(__('Search')); ?> </button>
                                    </div>

                                    <div class="search_job_result">
                                        <?php echo $__env->make('frontend.pages.subcategory-jobs.search-job-result', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php $__env->startSection('script'); ?>
    <?php echo $__env->make('frontend.pages.subcategory-jobs.jobs-filter-js', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('frontend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/subcategory-jobs/jobs.blade.php ENDPATH**/ ?>