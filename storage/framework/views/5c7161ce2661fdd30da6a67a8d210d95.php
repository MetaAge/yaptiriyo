    ...
    (function($) {
        ...
        $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            if (res.status === 'success' && res.states) {
                                let stateOptions = '<option value=""><?php echo e(__("Select State")); ?></option>';
            ...
            $(document).on('click', '#clear-all-filters', function(e) {
                ...
                // Call reset endpoint
                $.ajax({
                    url: "<?php echo e(route('subcategory.project.filter.reset')); ?>",
                    method: 'GET',
                    data: {
                        subcategory_id: originalSubcategoryId
                    },
                    beforeSend: function() {
                        $('.search_category_result').html('<div class="col-span-3 text-center py-8"><p class="text-gray-600"><?php echo e(__("Loading...")); ?></p></div>');
                    ...
                    success: function(res) {
                        if (res.status == 'nothing') {
                            ...
                            $('.project-count-display').text("<?php echo e(__('Showing')); ?> 0 <?php echo e(__('out of')); ?> 0 <?php echo e(__('results')); ?>");
                        } else {
                            $('.search_category_result').html(res.html);
                            if (res.count !== undefined && res.total !== undefined) {
                                $('.project-count-display').text("<?php echo e(__('Showing')); ?> " + res.count + " <?php echo e(__('out of')); ?> " + res.total + " <?php echo e(__('results')); ?>");
                            }
                        }
                        updateActiveFilters();
                    },
                    error: function(xhr) {
                        ...
                        $('.search_category_result').html('<div class="col-span-3 text-center py-8"><p class="text-red-600"><?php echo e(__("Error loading projects")); ?></p></div>');
                    }
                });
            });
            ...
            function updateActiveFilters() {
                ...
                if (skillsVal) {
                    ...
                    if (skills && skills !== '<?php echo e(__("Select Skill")); ?>') {
                        activeFilters.push({
                            label: skills,
                            field: 'skills'
                        });
                ...
                if (countryVal) {
                    ...
                    if (country && country !== '<?php echo e(__("Select Country")); ?>') {
                        activeFilters.push({
                            label: country,
                            field: 'country'
                        });
                ...
                if (stateVal) {
                    ...
                    if (state && state !== '<?php echo e(__("Select State")); ?>') {
                        activeFilters.push({
                            label: state,
                            field: 'state'
                        });
                ...
                if (deliveryVal) {
                    ...
                    if (deliveryDay && deliveryDay !== '<?php echo e(__("Select Delivery Time")); ?>') {
                        activeFilters.push({
                            label: deliveryDay,
                            field: 'delivery'
                        });
                ...
                if (levelVal) {
                    ...
                    if (level && level !== '<?php echo e(__("Select Experience Level")); ?>') {
                        activeFilters.push({
                            label: level,
                            field: 'level'
                        });
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/subcategory-projects/subcategory-project-filter-js.blade.php ENDPATH**/ ?>