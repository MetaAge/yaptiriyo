    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('keyup','#current_password',function(){
                ...
                $.ajax({
                    url: "<?php echo e(route('client.password.check')); ?>",
                    type: 'post',
            ...
            $('#password_change_form').on('submit',function(e){
               e.preventDefault();
               $.ajax({
                   url:"<?php echo e(route('client.password')); ?>",
                   method:'post',
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/client/password/password-js.blade.php ENDPATH**/ ?>