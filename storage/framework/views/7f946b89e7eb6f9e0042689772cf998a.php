        ...
        <div class="single-profile-settings-form custom-form">
            ...
            <div class="single-input">
                ...
                <div class="single-input mt-3">
                    <label for="title" class="label-title"><?php echo e(__('Hizmet Verilen Bölgeler')); ?></label>
                    <div class="form-control h-auto" style="min-height: 45px; background: #e9ecef; opacity: 1;">
                        <?php
                            $areas = Auth::guard('web')->user()->service_areas->map(fn($a) => optional($a->city)->city)->filter()->implode(', ');
                        ?>
                        <?php echo e($areas ?: __('Bölge seçilmedi')); ?>
            ...
            <?php endif; ?>
                <div class="single-input">
                    ...
                    <input value="<?php echo e(__(ucfirst(Auth::guard('web')->user()->experience_level)) ?? ''); ?>" class="form-control"
                           readonly disabled>
                </div>
        </div>
    </div>
</div>
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/freelancer/profile/profile-info.blade.php ENDPATH**/ ?>