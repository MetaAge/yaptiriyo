...
<div id="registerModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-[1001] hidden items-center justify-center p-4">
    <div class="relative w-full max-w-5xl z-30 bg-white rounded-3xl overflow-hidden max-h-[90vh] overflow-y-auto">
        ...
        <div id="registerStep1" class="bg-[url('<?php echo e(asset('assets/frontend/new_design/assets/images/login-page/loginpage.png')); ?>')] bg-cover bg-center bg-no-repeat min-h-[400px] flex items-center justify-center p-4 relative">
            ...
            <div class="relative w-full z-30 bg-white rounded-3xl">
                <div class="max-w-4xl m-auto p-8 md:p-12 lg:p-[4.5rem]">
                    <h1 class="text-2xl sm:text-3xl md:text-[28px] font-medium text-base-300 text-center mb-8 sm:mb-12">
                        <?php echo e(get_static_option('register_page_choose_role_title') ?? __('Join as a freelancer or client')); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-8">
                        <div id="registerFreelancerCard"
                            ...
                            <div class="flex flex-col items-center text-center">
                                <img src="<?php echo e(asset('assets/frontend/new_design/assets/images/login-page/user.svg')); ?>" alt="Freelancer" class="w-16 h-16 md:w-20 md:h-20" />
                                <h2 class="text-lg sm:text-xl md:text-xl font-medium text-base-300 mt-4 md:mt-6">
                                    <?php echo e(get_static_option('register_page_choose_join_freelancer_title') ?? __('Join as a Freelancer')); ?>
                        ...
                        <div id="registerClientCard"
                            ...
                            <div class="flex flex-col items-center text-center">
                                <img src="<?php echo e(asset('assets/frontend/new_design/assets/images/login-page/client.svg')); ?>" alt="Client" class="w-16 h-16 md:w-20 md:h-20" />
                                <h2 class="text-lg sm:text-xl md:text-xl font-medium text-base-300 mt-4 md:mt-6">
                            ...
                            <div class="w-full mt-6">
                                <div class="relative mb-4">
                                    ...
                                    <div class="relative flex justify-center text-sm">
                                        <span class="px-4 bg-white text-base-400"><?php echo e(__('or continue with')); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                    <button type="button" data-provider="google" class="social-register-btn flex items-center justify-start gap-2 px-4 py-[0.625rem] border-2 border-[#C4C8CE] rounded-lg hover:bg-gray-50 transition font-medium text-base-300">
                                        <img src="<?php echo e(asset('assets/frontend/new_design/assets/images/login-page/google.svg')); ?>" alt="google" class="w-5 h-5">
        ...
        <div id="registerStep2" class="p-8 md:p-12 hidden">
            <div class="max-w-4xl mx-auto">
                ...
                <h1 class="text-2xl sm:text-3xl font-semibold text-gray-900 mb-6"><?php echo e(__('Sign Up')); ?></h1>
                ...
                <?php if(get_static_option('login_page_social_login_enable_disable') == 'on'): ?>
                    ...
                    <div class="relative mb-6">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-4 bg-white text-base-400"><?php echo e(__('or continue with email')); ?></span>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <form id="modalRegisterForm" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="register_first_name" name="first_name" placeholder="<?php echo e(__('Type First Name')); ?>"
                        ...
                        <div>
                            ...
                            <input type="text" id="register_last_name" name="last_name" placeholder="<?php echo e(__('Type Last Name')); ?>"
                                   class="w-full px-4 py-3 border border-[#C4C8CE] rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none transition"
                                   required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="register_username" name="username" placeholder="<?php echo e(__('Type Username')); ?>"
                               class="w-full px-4 py-3 border border-[#C4C8CE] rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none transition"
                               required>
                    ...
                    <div>
                        <label for="register_email" class="block text-base font-medium text-base-300 mb-2">
                            <?php echo e(__('Email Address')); ?> <span class="text-red-500">*</span>
                        </label>
                        <input type="email" id="register_email" name="email" placeholder="<?php echo e(__('Type Email')); ?>"
                               class="w-full px-4 py-3 border border-[#C4C8CE] rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none transition"
                               required>
                    ...
                    <div>
                        <label for="register_phone" class="block text-base font-medium text-base-300 mb-2">
                            <?php echo e(__('Phone Number')); ?> <span class="text-red-500">*</span>
                        </label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" id="register_password" name="password" placeholder="<?php echo e(__('Type Password')); ?>"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" id="register_confirm_password" name="confirm_password" placeholder="<?php echo e(__('Confirm Password')); ?>"
                                       class="w-full px-4 py-3 border border-[#C4C8CE] rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none transition pr-12"
                                       required minlength="6" autocomplete="new-password">
                                <button type="button" class="modal-toggle-password absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700 focus:outline-none"
                    ...
                    <div class="flex items-start">
                        ...
                        <label for="register_terms_condition" class="ml-2 text-sm text-base-300">
                            ...
                            <a target="_blank" href="<?php echo e(url(get_static_option('toc_page_link') ?? '')); ?>"
                               class="text-primary hover:text-teal-700"><?php echo e(__('Terms and Conditions')); ?></a> &amp;
                            <a target="_blank" href="<?php echo e(url(get_static_option('privacy_policy_link') ?? '')); ?>"
                               class="text-primary hover:text-teal-700"><?php echo e(__('Privacy Policy')); ?></a>
                        </label>
                    </div>

                    <?php if(!empty(get_static_option('site_google_captcha_enable'))): ?>
                        <div class="my-3">
                            <div class="g-recaptcha" id="recaptcha_element_modal" data-sitekey="<?php echo e(get_static_option('recaptcha_site_key') ?? ''); ?>"></div>
                        </div>
                    <?php endif; ?>
                    ...
                    <button type="submit" id="modalRegisterBtn"
                        ...
                        <?php echo e(get_static_option('register_page_continue_button_title') ?? __('Sign Up Now')); ?>
        ...
        <div id="registerStep3" class="p-8 md:p-12 hidden">
            <div class="max-w-2xl mx-auto">
                <div class="border border-[#C4C8CE] p-6 lg:p-8 rounded-lg">
                    <h1 class="text-2xl sm:text-3xl font-medium text-gray-900 mb-6"><?php echo e(__('Verify Your Account')); ?></h1>
                    ...
                    <div id="modalAlertBanner" class="bg-amber-50 rounded-lg p-4 mb-6 flex items-start justify-between">
                        <p class="text-gray-700 text-sm flex-1">
                            <?php echo e(__('Please Check email inbox or spam box for verification code')); ?>
                        ...
                        <button id="modalCloseAlert"
                                ...
                                aria-label="<?php echo e(__('Close alert')); ?>">
                    ...
                    <div id="modalSuccessMessage" class="bg-green-50 rounded-lg p-4 mb-6 hidden">
                        <p class="text-green-800 text-sm">
                            <?php echo e(__('Verification code has been resent to your email')); ?>
                    ...
                    <form id="modalVerifyForm" novalidate>
                        <label for="modalVerificationCode" class="block text-gray-900 text-sm font-medium mb-2">
                            <?php echo e(__('Enter Verification code')); ?><span class="text-red-500">*</span>
                        </label>
...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            ...
            $('a[href="<?php echo e(route('user.register')); ?>"]').on('click', function(e) {
                e.preventDefault();
                $('#registerModal').removeClass('hidden').addClass('flex');
                $('body').addClass('overflow-hidden');
                resetRegisterModal();
            ...
            $(document).on('click', '.select-register-role', function() {
                ...
                let buttonText = selectedRegisterRole == 2 ?
                    '<?php echo e(__("Join as a Freelancer")); ?>' :
                    '<?php echo e(__("Join as a Client")); ?>';
            ...
            function checkPasswordMatch() {
                ...
                if (password.length > 0 || confirm_password.length > 0) {
                    if (password.length < 6) {
                        matchElement.html("<?php echo e(__('Password must be at least 6 characters')); ?>").css("color", "red");
                    } else if (confirm_password.length > 0 && password !== confirm_password) {
                        matchElement.html("<?php echo e(__('Passwords do not match!')); ?>").css("color", "red");
                    } else if (confirm_password.length > 0 && password === confirm_password) {
                        matchElement.html("<?php echo e(__('Passwords match!')); ?>").css("color", "green");
                    } else {
                        matchElement.html("");
                    }
                } else {
...
// Also check on page load/initialization
            ...
            $('#modalRegisterForm').on('submit', function(e) {
                ...
                // Validate password
                if (password.length < 6) {
                    erContainer.html('<div class="alert alert-danger rounded-lg p-3 mb-4"><p class="text-sm"><?php echo e(__("Password must be at least 6 characters")); ?></p></div>');
                ...
                if (password !== confirmPassword) {
                    erContainer.html('<div class="alert alert-danger rounded-lg p-3 mb-4"><p class="text-sm"><?php echo e(__("Passwords do not match")); ?></p></div>');
                    btn.prop('disabled', false);
                    $('#modal_user_register_load_spinner').html('');
                    return;
                }
                ...
                if (!$('#register_terms_condition').is(':checked')) {
                    erContainer.html('<div class="alert alert-danger rounded-lg p-3 mb-4"><p class="text-sm"><?php echo e(__("You must accept the terms and conditions")); ?></p></div>');
                    btn.prop('disabled', false);
                    $('#modal_user_register_load_spinner').html('');
                    return;
                }
                ...
                if (modalIti) {
                    ...
                    if (!modalIti.isValidNumber()) {
                        erContainer.html('<div class="alert alert-danger rounded-lg p-3 mb-4"><p class="text-sm"><?php echo e(__("Please enter a valid phone number")); ?></p></div>');
                        btn.prop('disabled', false);
                        $('#modal_user_register_load_spinner').html('');
                        return;
                    }
                ...
                if (document.getElementById('recaptcha_element_modal')) {
                    ...
                    if (!recaptchaResponse || recaptchaResponse.length === 0) {
                        erContainer.html('<div class="alert alert-danger rounded-lg p-3 mb-4"><p class="text-sm"><?php echo e(__("Google Captcha is required")); ?></p></div>');
                        btn.prop('disabled', false);
                        $('#modal_user_register_load_spinner').html('');
                        return;
                    }
            ...
            $('#modalVerifyForm').on('submit', function(e) {
                ...
                // Basic validation
                if (code.length !== 6) {
                    $('#modalCodeError').text('<?php echo e(__("Verification code must be 6 digits")); ?>').removeClass('hidden');
                    return;
                }

                btn.prop('disabled', true);
                btn.html('<i class="fas fa-spinner fa-spin mr-2"></i><?php echo e(__("Verifying...")); ?>');

                $.ajax({
                    url: "<?php echo e(route('email.verify')); ?>",
                    type: 'POST',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                    ...
                    success: function(response) {
                        if (response.success && response.redirect) {
                            $('#modalCodeError').text('<?php echo e(__("Verification successful! Redirecting...")); ?>')
                    ...
                    error: function(xhr) {
                        let errorMsg = '<?php echo e(__("Invalid verification code")); ?>';
                        ...
                        btn.prop('disabled', false);
                        btn.html('<?php echo e(__("Verify Account")); ?>');
            ...
            $('#modalResendCode').on('click', function() {
                ...
                btn.prop('disabled', true).html('<i class="fas fa-spinner fa-spin mr-1"></i><?php echo e(__("Sending...")); ?>');

                $.ajax({
                    url: "<?php echo e(route('resend.verify.code')); ?>",
                    type: 'GET',
                    dataType: 'json',
                    success: function(response) {
                        if (response.success) {
                            $('#modalSuccessMessage').find('p').text(response.message || '<?php echo e(__("Verification code has been resent to your email")); ?>');
                    ...
                    error: function(xhr) {
                        let errorMsg = '<?php echo e(__("Failed to resend code. Please try again.")); ?>';
                        if (xhr.responseJSON && xhr.responseJSON.message) {
                            errorMsg = xhr.responseJSON.message;
                        }
                        alert(errorMsg);
            ...
            $('.social-register-btn').on('click', function(e) {
                ...
                let redirectUrl = '';
                if (provider === 'google') {
                    redirectUrl = '<?php echo e(route('login.google.redirect')); ?>' + '?user_type=' + user_type;
                } else if (provider === 'facebook') {
                    redirectUrl = '<?php echo e(route('login.facebook.redirect')); ?>' + '?user_type=' + user_type;
                }
            ...
            function resetRegisterModal() {
                ...
                $('#modalVerifyBtn').html('<?php echo e(__("Verify Account")); ?>');
...
</script><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/new_design/layout/partial/register-modal.blade.php ENDPATH**/ ?>