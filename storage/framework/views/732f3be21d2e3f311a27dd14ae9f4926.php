    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.user.subscription.search')); ?>",
                    method:'GET',
            ...
            $(document).on('click','#active_subscription',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.user.subscription.active')); ?>",
                    method:'GET',
                    data:{string_search:string_search},
                    success:function(res){
                        if(res.status=='nothing'){
            ...
            $(document).on('click','#inactive_subscription',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.user.subscription.inactive')); ?>",
                    method:'GET',
                    data:{string_search:string_search},
                    success:function(res){
                        if(res.status=='nothing'){
            ...
            $(document).on('click','#manual_subscription',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.user.subscription.manual')); ?>",
                    method:'GET',
                    data:{string_search:string_search},
                    success:function(res){
                        if(res.status=='nothing'){
            ...
            $(document).on('click','.edit_payment_gateway_modal',function(){
                ...
                let manual_payment_image = "<?php echo e(url('/assets/uploads/manual-payment/subscription')); ?>/" + img_name;
                ...
                if (extension.toLowerCase() === 'pdf') {
                    $('.manual_payment_img').html(`<a href="${manual_payment_image}" class="text-primary" download"><?php echo e(__('Download Pdf')); ?></a>`);
                } else {
                    $('.manual_payment_img').html(`<img src="${manual_payment_image}" alt="<?php echo e(__('Manual Payment Image')); ?>">`);
                }
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/Modules/Subscription/Resources/views/backend/user-subscription/subscription-js.blade.php ENDPATH**/ ?>