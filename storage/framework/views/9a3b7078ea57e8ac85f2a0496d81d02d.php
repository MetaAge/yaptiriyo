...
<?php endif; ?>
                                    ...
                                    <?php
                                        ...
                                        $freelancerRating = \App\Models\Rating::where('order_id', $order_details->id)
                                                ->where('sender_type', 2)
                                ...
                                <div class="myOrder-single-flex flex-between">
                                    <div class="btn-wrapper flex-btn">
                                        ...
                                        <?php if($order_details->status == 3): ?>
                                            ...
                                            <?php if(!$freelancerRating): ?>
                                                <a href="<?php echo e(route('freelancer.order.rating',$order_details->id)); ?>" class="btn-profile btn-bg-1"><?php echo e(__('Submit Reply')); ?>
                                        ...
                                        <?php if($order_details->status != 3): ?>
                                            <?php if($order_details->is_fixed_hourly == 'hourly' && $order_details->status != 0): ?>
                                                <a href="<?php echo e(route('freelancer.order.time.tracker',$order_details->id)); ?>" class="btn-profile btn-bg-1"><?php echo e(__('Start Tracking')); ?></a>
                                            <?php endif; ?>
                                        <?php endif; ?>

                                        <?php if($order_details->is_fixed_hourly == 'hourly' && $order_details->status != 0): ?>
                                            <a href="<?php echo e(route('freelancer.order.work.history',$order_details->id)); ?>" class="btn-profile btn-bg-1"><?php echo e(__('Work History')); ?></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
...
<?php endif; ?>
                                            ...
                                            <?php if($mile_stones->count() <= 0): ?>
                                                ...
                                                <?php endif; ?>
                                                <?php if(Auth::guard('web')->user()->user_type == 1 && $order_details->status == 1 && Session::get('user_role') == 'freelancer'): ?>
                                                    <a href="javascript:void(0)"
                                                       class="btn-profile btn-bg-1 order_submit"
                                                       data-bs-toggle="modal"
                                                       data-bs-target="#orderSubmitModal"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.order.profile-image','data' => ['image' => $order_details?->user->image,'loadFrom' => $order_details?->user->load_from]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['image' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($order_details?->user->image),'loadFrom' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($order_details?->user->load_from)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <?php echo $__env->make('frontend.user.freelancer.order.order-submit', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('frontend.user.freelancer.order.revision-details', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('frontend.user.freelancer.order.report-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('frontend.user.freelancer.order.order-submit-description', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?>
    <?php echo $__env->make('frontend.user.freelancer.order.order-js', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/freelancer/order/order-details.blade.php ENDPATH**/ ?>