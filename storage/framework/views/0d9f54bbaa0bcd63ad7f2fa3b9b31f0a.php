...
<?php if($notification->type =='Create Job' || $notification->type =='Edit Job' || $notification->type =='Job'): ?>
...
<?php if(moduleExists('PromoteFreelancer')): ?>
    <?php if($notification->type =='Buy Package' || $notification->type =='project'): ?>
        <a href="<?php echo e(route('admin.project.promoted.list')); ?>" class="dashboard__notification__list__item click-notification">
            <div class="dashboard__notification__list__left">
                <div class="dashboard__notification__list__icon decline">
                    <?php echo e(site_currency_symbol()); ?>
    ...
    <?php endif; ?>
    <?php if($notification->type =='profile'): ?>
        <a href="<?php echo e(route('admin.profile.promoted.list')); ?>" class="dashboard__notification__list__item click-notification">
            <div class="dashboard__notification__list__left">
                <div class="dashboard__notification__list__icon decline">
                    <?php echo e(site_currency_symbol()); ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/components/backend/admin-notification.blade.php ENDPATH**/ ?>