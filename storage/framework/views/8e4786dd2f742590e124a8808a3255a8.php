<script>
    (function($){
        ...
        $(document).ready(function(){
            ...
            $('.service_areas_select2').select2({
                dropdownParent: $('.popup-fixed'),
                placeholder: "<?php echo e(__('Select Service Areas')); ?>"
            });
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.status == 'success') {
                            ...
                            $("#service_areas").html(all_options); // Also populate service areas
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/freelancer/profile/profile-js.blade.php ENDPATH**/ ?>