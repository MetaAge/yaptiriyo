            ...
            <?php if(Auth::guard('web')->check()): ?>
                <?php if(Auth::guard('web')->user()->user_type == 2): ?>
                    ...
                    <ul class="profile-settings-menu-list">
                        ...
                        <?php if(moduleExists('StripeConnect')): ?>
                        <li class="profile-settings-menu-item <?php if(request()->routeIs('freelancer.stripe.account')): ?> active <?php endif; ?>">
                            <a href="<?php echo e(route('freelancer.stripe.account')); ?>" class="profile-settings-menu-item-link">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M17 22.75H7C3.56 22.75 1.25 20.44 1.25 17V12C1.25 8.92 3.15 6.69001 6.1 6.32001C6.38 6.28001 6.69 6.25 7 6.25H17C17.24 6.25 17.55 6.26 17.87 6.31C20.82 6.65 22.75 8.89 22.75 12V17C22.75 20.44 20.44 22.75 17 22.75ZM7 7.75C6.76 7.75 6.53 7.76999 6.3 7.79999C4.1 8.07999 2.75 9.68 2.75 12V17C2.75 19.58 4.42 21.25 7 21.25H17C19.58 21.25 21.25 19.58 21.25 17V12C21.25 9.66 19.88 8.05001 17.66 7.79001C17.42 7.75001 17.21 7.75 17 7.75H7Z"
                                ...
                                <?php echo e(__('Connect Bank Account')); ?>
                ...
                <?php else: ?>
                    ...
                    <?php else: ?>
                        <ul class="profile-settings-menu-list">
                            ...
                            <?php endif; ?>
                            <?php if(get_static_option('subscription_enable_disable') != 'disable'): ?>
                                <li class="profile-settings-menu-item <?php if(request()->routeIs('client.subscriptions.all')): ?> active <?php endif; ?>">
                                    <a href="<?php echo e(route('client.subscriptions.all')); ?>"
                                       class="profile-settings-menu-item-link">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            <?php if(moduleExists('StripeConnect')): ?>
                                <li class="profile-settings-menu-item <?php if(request()->routeIs('client.transaction.history')): ?> active <?php endif; ?>">
                                    <a href="<?php echo e(route('client.transaction.history')); ?>" class="profile-settings-menu-item-link">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                    d="M17 22.75H7C3.56 22.75 1.25 20.44 1.25 17V12C1.25 8.92 3.15 6.69001 6.1 6.32001C6.38 6.28001 6.69 6.25 7 6.25H17C17.24 6.25 17.55 6.26 17.87 6.31C20.82 6.65 22.75 8.89 22.75 12V17C22.75 20.44 20.44 22.75 17 22.75ZM7 7.75C6.76 7.75 6.53 7.76999 6.3 7.79999C4.1 8.07999 2.75 9.68 2.75 12V17C2.75 19.58 4.42 21.25 7 21.25H17C19.58 21.25 21.25 19.58 21.25 17V12C21.25 9.66 19.88 8.05001 17.66 7.79001C17.42 7.75001 17.21 7.75 17 7.75H7Z"
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/layout/partials/sidebar.blade.php ENDPATH**/ ?>