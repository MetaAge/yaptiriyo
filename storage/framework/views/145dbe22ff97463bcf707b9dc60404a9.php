        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#set_price_range', function() {
                ...
                if (isNaN(min_price) || isNaN(max_price)) {
                    toastr_warning_js("<?php echo e(__('Both fields are required!')); ?>");
                    return false;
                }

                // check negative
                if (min_price < 0 || max_price < 0) {
                    toastr_warning_js("<?php echo e(__('Price cannot be negative!')); ?>");
                    return false;
                }

                // check range
                if (min_price > max_price) {
                    toastr_warning_js("<?php echo e(__('Minimum price cannot be greater than maximum price!')); ?>");
                    return false;
                }
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/subcategory-jobs/jobs-filter-js.blade.php ENDPATH**/ ?>