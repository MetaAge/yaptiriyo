    ...
    <div class="w-80 bg-white rounded-lg shadow-lg border border-gray-200 p-6 h-screen overflow-y-auto fixed left-0 top-0 custom-scrollbar overflow-hidden">
        ...
        <div class="mb-8">
            ...
            <div class="relative">
                ...
                <input type="text" id="talent_search_string" placeholder="<?php echo e(__('e.g. Graphic Designer')); ?>"
        ...
        <div class="mb-8">
            ...
            <select id="skills" class="my-select custom-select w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:border-primary bg-white">
                ...
                <?php $__currentLoopData = $skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($skill->skill); ?>"><?php echo e($skill->skill); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        ...
        <?php if(moduleExists('FreelancerLevel')): ?>
            ...
            ?>
            <div class="mb-8">
                <label class="block text-lg font-medium mb-4 text-base-300 text-black/80"><?php echo e(__('Talent Badge')); ?></label>
                <select id="talent_badge" class="my-select custom-select w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:border-primary bg-white">
                    <option value=""><?php echo e(__('Select Badge')); ?></option>
        ...
        <!-- Price Range -->
        <div class="mb-12">
            <label class="block text-lg font-medium mb-4 text-base-300 text-black/80"><?php echo e(__('Hourly Rate Range')); ?></label>
...
</div><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/talent/sidebar.blade.php ENDPATH**/ ?>