    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','.submit_order_details',function(e){
                e.preventDefault();
                $(this).prop('disabled', true).text('<?php echo e(__("Processing...")); ?>');

                let attachment = $('#attachment').val();
                let description = $('#description').val();

                if(description == ''){
                    toastr_warning_js("<?php echo e(__('Please fill description field')); ?>");
                    return false;
                }
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/freelancer/order/order-js.blade.php ENDPATH**/ ?>