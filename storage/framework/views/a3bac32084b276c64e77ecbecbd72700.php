    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            function countries(page){
                $.ajax({
                    url:"<?php echo e(route('admin.freelancer.paginate.data').'?page='); ?>" + page,
                    success:function(res){
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.freelancer.search')); ?>",
                    method:'GET',
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/backend/pages/user/user-js.blade.php ENDPATH**/ ?>