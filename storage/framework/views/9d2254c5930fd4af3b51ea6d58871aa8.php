        ...
        $(document).ready(function () {
            ...
            $(document).on('change','.checkbox_or_numeric_select',function(){
                ...
                currentRow.each(function (){
                    ...
                    if($('#offer_packages_available_or_not').val() != 1 && i > 1){
                        ...
                        textField = '<input type="text" name="'+ inputName +'" class="form-control disabled_or_not text-input" maxlength="60" placeholder="<?php echo e(__("Enter text (max 60 chars)")); ?>"><div class="char-counter">0/60</div>';
                    }else{
                        ...
                        textField = '<input type="text" name="'+ inputName +'" class="form-control text-input" maxlength="60" placeholder="<?php echo e(__("Enter text (max 60 chars)")); ?>"><div class="char-counter">0/60</div>';
                    }
                    ...
                    let priceField = '<input type="number" name="'+ priceName +'" class="form-control price-input mt-1" placeholder="<?php echo e(__('Extra price')); ?>" min="0">';
                       ...
                       <th>
                        ...
                        <td>
                                <div class="d-flex flex-column gap-1">
                                    ...
                                    <input type="number" name="title[basic_price]" class="form-control price-input"
                        ...
                        <td>
                                <div class="d-flex flex-column gap-1">
                                    ...
                                    <input type="number" name="title[standard_price]" class="form-control price-input"
                                    placeholder="<?php echo e(__('Extra price')); ?>" min="0">
                                </div>
                        </td>
                        ...
                        <td>
                            <div class="d-flex flex-column gap-1">
                                ...
                                <input type="number" name="title[premium_price]" class="form-control price-input"
                                    placeholder="<?php echo e(__('Extra price')); ?>" min="0">
            ...
            $(document).on('click','.basic_price_setup',function(){
                ...
                if (basic_discount_charge && Number(basic_discount_charge) >= Number(basic_regular_charge)) {
                    toastr_warning_js("<?php echo e(__('Discount price cannot be equal to or greater than regular price!')); ?>");
                    return false;
                }
    ...
    function pre_next()
    {
        ...
        $(document).on("click", "#next", function (e){
            ...
            if (current <= Listings.length) {
                ...
                // **MODIFIED: Add restricted word check**
                if(current == 1){
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/freelancer/project/edit/edit-project-js.blade.php ENDPATH**/ ?>