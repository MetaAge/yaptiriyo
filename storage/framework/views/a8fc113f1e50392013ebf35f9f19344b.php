                                ...
                                <div class="jobFilter-proposal-author-thumb position-relative">
                                    <?php if($proposal?->freelancer->image): ?>
                                        <?php if(cloudStorageExist() && in_array(Storage::getDefaultDriver(), ['s3', 'cloudFlareR2', 'wasabi'])): ?>
                                            <img src="<?php echo e(render_frontend_cloud_image_if_module_exists( 'profile/'. $proposal?->freelancer?->image, load_from: $proposal?->freelancer?->load_from)); ?>" alt="<?php echo e($proposal?->freelancer?->first_name); ?>">
                                        <?php else: ?>
...
</div><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/client/job/job-details/proposals.blade.php ENDPATH**/ ?>