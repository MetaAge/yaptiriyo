...
<?php endif; ?>
                ...
                <?php if(moduleExists('PromoteFreelancer') && $project->is_pro_project): ?>
                    <!-- Pro Badge -->
                    ...
                    <div class="text-right flex items-center gap-1">
                        ...
                        <p class="text-lg font-semibold text-gray-800">
                            <?php if($project->basic_discount_charge): ?>
                                <?php echo e(yaptiriyo_price_label($project->basic_discount_charge, $project->pricing_type)); ?>

                            <?php else: ?>
                                <?php echo e(yaptiriyo_price_label($project->basic_regular_charge, $project->pricing_type)); ?>
            ...
            <section>
                <div class="flex items-center justify-center h-full w-full py-10">
                    <div class="max-w-lg flex flex-col items-center justify-center text-center">
                        <img src="<?php echo e(asset('assets/frontend/new_design/assets/images/error-images/no_service_found.svg')); ?>" alt="nothing-found">
                        <p class="text-base-300 text-base-400 text-lg"><?php echo e(__('Sorry, no results found.')); ?></p>
                    </div>
                </div>
            </section>
        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        initializeCardVideoPlayers();
    });

    // Also reinitialize after AJAX loads
    if (typeof jQuery !== 'undefined') {
        $(document).ajaxComplete(function() {
            setTimeout(initializeCardVideoPlayers, 100);
        });
    }

    function initializeCardVideoPlayers() {
...
</script><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/category-projects/search-category-result.blade.php ENDPATH**/ ?>