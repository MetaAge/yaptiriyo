    ...
    (function($) {
        ...
        $(document).ready(function() {
                    ...
                    if (priceElement.length > 0) {
                        ...
                        if (priceText) {
                            ...
                            let thousand_separator =
                                "<?php echo e(get_static_option('site_currency_thousand_separator')); ?>";
                            let decimal_separator =
                                "<?php echo e(get_static_option('site_currency_decimal_separator')); ?>";
            ...
            function formatPrice(price) {
                let thousand_separator = "<?php echo e(get_static_option('site_currency_thousand_separator') ?? ','); ?>";
                let decimal_separator = "<?php echo e(get_static_option('site_currency_decimal_separator') ?? '.'); ?>";
            ...
            function updateTransactionFee(currentTab) {
                ...
                if (totalPrice > wallet_balance && wallet_balance > 0) {
                    ...
                    $('.display_balance').html(
                        '<span class="text-danger"><?php echo e(__('Wallet Balance Shortage:')); ?>' +
                        site_default_currency_symbol + formatPrice(shortage) + '</span>');
                    $('.deposit_link').html(
                        '<a href="<?php echo e($user_type); ?>" target="_blank"><?php echo e(__('Deposit')); ?></a>');
                } else {
                    $('.display_balance').html('');
                    $('.deposit_link').html('');
                }
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/order/order-js.blade.php ENDPATH**/ ?>