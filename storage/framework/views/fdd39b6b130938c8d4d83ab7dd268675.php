...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb.user-profile-breadcrumb-02','data' => ['innerTitle' => __('All Talents')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['innerTitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('All Talents'))]); ?>
...
<?php endif; ?>
        ...
        <section class="bg-[#F8F9FD]">
            <div class="max-w-7xl mx-auto px-6 py-8 md:py-12 lg:py-16">
                <div class="mb-8">
                    <h1 class="text-3xl font-medium mb-2 text-base-300"><?php echo e(__('All Talents')); ?></h1>
                    <p class="text-base-400"><?php echo e(__('Discover our top rated talents')); ?></p>
                </div>
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-8">
                    <div class="flex items-center gap-4">
                        ...
                        <span class="text-base-400 talent-count-display"><?php echo e(__('Showing')); ?> <?php echo e($talents->count()); ?> <?php echo e(__('out of')); ?> <?php echo e($talents->total()); ?> <?php echo e(__('results')); ?></span>
                    </div>
                    ...
                    <div class="flex items-center gap-3 whitespace-nowrap md:self-auto w-full sm:w-auto justify-end">
                        ...
                        <div class="relative min-w-[180px] w-full sm:w-auto">
                            <select title="sort by" id="sort_by"
                                ...
                                <option value="price_high"><?php echo e(__('Rate: High to Low')); ?></option>
                                <option value="price_low"><?php echo e(__('Rate: Low to High')); ?></option>
                            </select>
            ...
            <?php echo e(__('Clear All')); ?>
                ...
                <!-- Talents Grid -->
                <div class="search_talent_result">
                    <?php echo $__env->make('frontend.pages.talent.search-talent-result', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>

                <!-- Sidebar Filter -->
                <?php echo $__env->make('frontend.pages.talent.sidebar', [
...
<?php $__env->startPush('page_scripts'); ?>
    <script>
        ...
        window.routes.talentsFilter = "<?php echo e(route('talents.filter')); ?>";
        window.routes.talentsPagination = "<?php echo e(route('talents.pagination')); ?>";
        window.routes.talentsFilterReset = "<?php echo e(route('talents.filter.reset')); ?>";
        window.csrfToken = "<?php echo e(csrf_token()); ?>";
    </script>

    <?php echo $__env->make('frontend.pages.talent.talent-filter-js', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.new_design.layout.new_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/talent/talents.blade.php ENDPATH**/ ?>