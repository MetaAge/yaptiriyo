                    ...
                    <div class="login-bottom-contents">
                        ...
                        <div class="login-others">
                            <div class="login-others-single">
                                <a href="<?php echo e(route('login.google.redirect')); ?>" class="login-others-single-btn w-100 social-login-btn" data-provider="google">
                            ...
                            <div class="login-others-single">
                                <a href="<?php echo e(route('login.facebook.redirect')); ?>" class="login-others-single-btn w-100 social-login-btn" data-provider="facebook">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.register.user-register-slider','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
        ...
        (function($) {
            ...
            $(document).ready(function() {
                ...
                $(document).on('keyup', '#phones', function() {
                    var iti = window.intlTelInputGlobals.getInstance(document.querySelector("#phones"));
                ...
                $(document).on('keyup', '#confirm_password', function() {
                    ...
                    if(password.length >= 6 && confirm_password.length >= 6) {
                        if (password != confirm_password) {
                            $("#check_password_match").html("<?php echo e(__('Password does not match !')); ?>").css("color", "red");
                        } else {
                            $("#check_password_match").html("<?php echo e(__('Password match !')); ?>").css("color", "green");
                        }
                    }else{
...
<?php echo $__env->make('frontend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/user-register.blade.php ENDPATH**/ ?>