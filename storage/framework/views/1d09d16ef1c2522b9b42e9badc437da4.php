<?php if(Auth::guard('web')->check() &&
    ...
    <div class="profile-wrapper-item radius-10">
        <div class="profile-wrapper-item-flex flex-between align-items-center profile-border-bottom">
            ...
            <div class="profile-wrapper-item-plus display_edit_skill_wrapper edit_skill_show_hide"><i
        ...
        <ul class="setup-wrapper-work-list freelancer_skill_list">
            ...
            <?php for($i = 0; $i <= $array_length - 1; $i++): ?>
                <li class="setup-wrapper-work-list-item">
                    <a href="<?php echo e(route('talents.all')); ?>?skill=<?php echo e(urlencode($array_skill[$i])); ?>" class="skill-link">
        ...
        <div class="edit_skill_wrapper">
            <div class="setup-wrapper-skill">
                <p class="setup-wrapper-skill-para">
                    <?php echo e(__('Type and hit ↵ Enter to add a skill or choose from suggestions below')); ?></p>
            ...
            <ul class="setup-wrapper-work-list mt-3 overflow-auto set_scroll_height">
            ...
            <div class="btn-wrapper d-flex justify-content-end mt-3">
                <a href="javascript:void(0)"
                    class="cmn-btn btn-bg-1 btn-small update_freelancer_skill"><?php echo e(__('Update Skills')); ?></a>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/profile-details/skill.blade.php ENDPATH**/ ?>