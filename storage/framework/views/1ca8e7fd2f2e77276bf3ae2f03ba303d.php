...
<div class="popup-fixed education-popup">
    <div class="popup-contents">
        ...
        <h2 class="popup-contents-title"> <?php echo e(get_static_option('education_edit_modal_title') ?? __('Edit Educational Background')); ?> </h2>
...
<?php endif; ?>
        ...
        <div class="popup-contents-btn flex-btn justify-content-end profile-border-top">
            ...
            <a href="javascript:void(0)" class="btn-profile btn-bg-1 update_single_education"><?php echo e(__('Save')); ?></a>
        </div>
    </div>
</div>
<!-- Edit Education Ends  -->
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/freelancer/account/education/edit-education-modal.blade.php ENDPATH**/ ?>