                        ...
                        <a href="" class="dashboard__promo__col promo_child">
                            <div class="single_promo">
                                <div class="single_promo__contents">
                                    ...
                                    <h4 class="single_promo__title mt-2"> <?php echo e(float_amount_with_currency_symbol($total_revenue ?? 0)); ?> </h4>
                                </div>
                            </div>
                        </a>
                        <a href="<?php echo e(route('admin.order.all')); ?>" class="dashboard__promo__col promo_child">
                            <div class="single_promo">
                                <div class="single_promo__contents">
                                    ...
                                    <h4 class="single_promo__title mt-2"> <?php echo e(float_amount_with_currency_symbol($total_order_revenue ?? 0)); ?> </h4>
                                </div>
                            </div>
                        </a>
                        <a href="<?php echo e(route('admin.user.subscription.all')); ?>" class="dashboard__promo__col promo_child">
                            <div class="single_promo">
                                <div class="single_promo__contents">
                                    ...
                                    <h4 class="single_promo__title mt-2"> <?php echo e(float_amount_with_currency_symbol($total_subscription_revenue ?? 0)); ?> </h4>
                                </div>
                            </div>
                        </a>
                            ...
                            <a href="" class="dashboard__promo__col promo_child">
                                <div class="single_promo">
                                    <div class="single_promo__contents">
                                        ...
                                        <h4 class="single_promo__title mt-2"> <?php echo e(float_amount_with_currency_symbol($total_promotion_revenue ?? 0)); ?> </h4>
                                    </div>
                                </div>
                            </a>
                        <?php endif; ?>
                        <a href="<?php echo e(route('admin.jobs')); ?>" class="dashboard__promo__col promo_child">
                            <div class="single_promo">
                                <div class="single_promo__contents">
                                    ...
                                    <h4 class="single_promo__title mt-2"><?php echo e($total_job ?? 0); ?> </h4>
                                </div>
                            </div>
                        </a>
                        <a href="<?php echo e(route('admin.freelancer.all')); ?>" class="dashboard__promo__col promo_child">
                            <div class="single_promo">
                                <div class="single_promo__contents">
                                    ...
                                    <h4 class="single_promo__title mt-2"> <?php echo e($total_freelancer ?? 0); ?> </h4>
                                </div>
                            </div>
                        </a>
                        <a href="<?php echo e(route('admin.client.all')); ?>" class="dashboard__promo__col promo_child">
                            <div class="single_promo">
                                <div class="single_promo__contents">
                                    ...
                                    <h4 class="single_promo__title mt-2"> <?php echo e($total_client ?? 0); ?></h4>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="dashboard__maps__footer mt-4">
                        ...
                        <ul class="dashboard__maps__footer__list mt-4">
                            <li class="dashboard__maps__footer__list_item">
                                ...
                                <span class="dashboard__maps__footer__list__count"><?php echo e(get_static_option('admin_commission_type') ? ucfirst(get_static_option('admin_commission_type')) : ''); ?></span>
                            </li>
                            <li class="dashboard__maps__footer__list_item">
                                <span class="dashboard__maps__footer__list__country"><?php echo e(__('Commission Charge')); ?></span>
                                <span class="dashboard__maps__footer__list__count"><?php echo e(get_static_option('admin_commission_charge') ?? 0); ?></span>
                            </li>
                            <li class="dashboard__maps__footer__list_item">
                                <span class="dashboard__maps__footer__list__country"><?php echo e(__('Transaction Fee Type')); ?></span>
                                <span class="dashboard__maps__footer__list__count"><?php echo e(get_static_option('transaction_fee_type') ? ucfirst(get_static_option('transaction_fee_type')) : ''); ?></span>
                            </li>
                            <li class="dashboard__maps__footer__list_item">
                                <span class="dashboard__maps__footer__list__country"><?php echo e(__('Transaction Fee Charge')); ?></span>
                                <span class="dashboard__maps__footer__list__count"><?php echo e(get_static_option('transaction_fee_charge') ?? 0); ?></span>
                            </li>
                            <li class="dashboard__maps__footer__list_item">
                            ...
                            <li class="dashboard__maps__footer__list_item">
                                ...
                                <span class="dashboard__maps__footer__list__count"><?php echo e(get_static_option('job_auto_approval') ? ucfirst(get_static_option('job_auto_approval')) : ''); ?></span>
                            </li>
                            <li class="dashboard__maps__footer__list_item">
                                <span class="dashboard__maps__footer__list__country"><?php echo e(__('Project Auto Approval')); ?></span>
                                <span class="dashboard__maps__footer__list__count"><?php echo e(get_static_option('project_auto_approval') ? ucfirst(get_static_option('project_auto_approval')) : ''); ?></span>
                            </li>
                            <?php
                                $withdraw_fee = get_static_option('withdraw_fee') ?? 0;
                                $withdraw_fee_type = get_static_option('withdraw_fee_type') ?? 'fixed';
                            ?>
                            <li class="dashboard__maps__footer__list_item">
                                <span class="dashboard__maps__footer__list__country"><?php echo e(__('Withdraw Fee')); ?></span>
                                <span class="dashboard__maps__footer__list__count">
                                    <?php if($withdraw_fee_type === 'percentage'): ?>
                                        <?php echo e(float_amount_without_currency_symbol($withdraw_fee)); ?>%
                                    <?php else: ?>
                                        <?php echo e(float_amount_with_currency_symbol($withdraw_fee)); ?>
                            ...
                            <li class="dashboard__maps__footer__list_item">
                                <span class="dashboard__maps__footer__list__country"><?php echo e(__('Minimum Deposit Amount')); ?></span>
                                <span class="dashboard__maps__footer__list__count"><?php echo e(float_amount_with_currency_symbol(get_static_option('minimum_deposit_amount') ?? 0)); ?></span>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <table class="table table-responsive">
                                    ...
                                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($order->is_project_job ? ucfirst($order->is_project_job) : ''); ?></td>
                                            <td><?php echo e(float_amount_with_currency_symbol($order->price ?? 0)); ?></td>
                                            <td>
...
<?php endif; ?> </td>
                                            <td><?php echo e($order->created_at ? $order->created_at->format('Y-m-d') : ''); ?></td>
                                        </tr>
...
<?php echo $__env->make('backend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/backend/pages/dashboard/dashboard.blade.php ENDPATH**/ ?>