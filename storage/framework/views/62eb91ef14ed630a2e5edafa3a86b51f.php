    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('keyup','#current_password',function(){
                ...
                $.ajax({
                    url: "<?php echo e(route('freelancer.password.check')); ?>",
                    type: 'post',
            ...
            $('#password_change_form').on('submit',function(e){
                e.preventDefault();
                $.ajax({
                    url:"<?php echo e(route('freelancer.password')); ?>",
                    method:'post',
                    ...
                    success:function(res){
                        ...
                        if(res.status=='success'){
                            ...
                            toastr_success_js("<?php echo e(__('Password successfully changed.')); ?>");
                        }
                        if(res.status=='not_match'){
                            toastr_warning_js("<?php echo e(__('Password and confirm password not match.')); ?>");
                        }
                        if(res.status=='current_pass_wrong'){
                            toastr_warning_js("<?php echo e(__('Current password is wrong.')); ?>");
                        }
                    },
                    error: function (err) {
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/freelancer/password/password-js.blade.php ENDPATH**/ ?>