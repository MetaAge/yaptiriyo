    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('submit','#profile_photo_change',function(e){
                e.preventDefault();
                $.ajax({
                    url:"<?php echo e(route('client.profile.photo.edit')); ?>",
                    method:'post',
            ...
            $(document).on('submit','#edit_profile_form',function(e){
                ...
                if(first_name == '' || last_name == '' || email == '' || country == ''){
                    ...
                    $.ajax({
                        url: "<?php echo e(route('client.profile.edit')); ?>",
                        type: 'post',
                        data: {
...
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/client/profile/profile-js.blade.php ENDPATH**/ ?>