                    ...
                    <div class="global-search-result-inner-item-thumb">
                        ...
                        <?php else: ?>
                            <img src="<?php echo e(asset('assets/uploads/project/' . $project->first_image) ?? ''); ?>"
                                 alt="<?php echo e($project->first_image ?? ''); ?>">
                        <?php endif; ?>
                    </div>
...
<?php endif; ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/frontend-home-job-search-result.blade.php ENDPATH**/ ?>