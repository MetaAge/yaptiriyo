                                    ...
                                    <?php if($all_admins->count() >=1): ?>
                                        <?php $__currentLoopData = $all_admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="w-100px h-100px"><?php echo render_image_markup_by_attachment_id($admin->image,'','thumb'); ?></td>
                                                <td>
...
<?php echo $__env->make('backend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/Modules/RolePermission/Resources/views/admin-manage/all-admins.blade.php ENDPATH**/ ?>