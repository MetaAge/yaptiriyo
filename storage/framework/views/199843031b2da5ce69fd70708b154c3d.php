...
<?php endif; ?>
                    ...
                    <?php if(moduleExists('Community')): ?>
                        <a href="<?php echo e(route('community.all')); ?>" class="navbar-author-wrapper-list-item">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
...
</div><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/components/frontend/menu-user-items.blade.php ENDPATH**/ ?>