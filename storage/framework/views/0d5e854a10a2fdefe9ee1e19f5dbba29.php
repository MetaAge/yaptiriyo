...
<div class="setup-wrapper-contents">
    <div class="create-project-wrapper-item">
        <div class="create-project-wrapper-item-top profile-border-bottom">
            ...
            <div class="custom_switch_wrapper d-none">
                <label class="custom_switch">
                    <input class="custom-switch" type="checkbox" name="offer_packages_available_or_not" id="offer_packages_available_or_not" value="0">
            ...
            <div class="package-table">
                ...
                <table class="table table-bordered table-responsive create_project_table">
                    ...
                    <tr>
                        ...
                        <th class="package-head">
                            <div class="package-head-flex flex-between align-items-center">
                                <span class="package-head-title" id="basic_title" data-title="Basic"><?php echo e(__($project_details->basic_title) ?? __('Basic')); ?></span>
                                <span class="package-head-edit"></span>
                            </div>
                        </th>
                        <th class="package-head d-none">
                            <div class="package-head-flex flex-between align-items-center">
                                <span class="package-head-title" id="standard_title" data-title="Standard"><?php echo e(__($project_details->standard_title) ?? __('Standard')); ?></span>
                                <span class="package-head-edit"></span>
                            </div>
                        </th>
                        <th class="package-head d-none">
                            <div class="package-head-flex flex-between align-items-center">
                                <span class="package-head-title" id="premium_title" data-title="Premium"><?php echo e(__($project_details->premium_title) ?? __('Premium')); ?></span>
                                <span class="package-head-edit"></span>
                            </div>
                        </th>
                    </tr>
                    ...
                    <tr>
                        <th>
                            <div class="package-head-left">
                                <span class="package-head-left-title"><?php echo e(__('Hizmet Süresi')); ?></span>
                            </div>
                        </th>
                        ...
                        <?php if($all_lengths->count() >= 1): ?>
                                ...
                                <div class="package-select">
                                    <select class="form-control" name="basic_delivery" id="basic_delivery">
                                        <?php $__currentLoopData = $all_lengths; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $length): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($length->length); ?>" <?php echo e($project_details->basic_delivery ===  $length->length ? 'selected' : ''); ?>><?php echo e($length->length); ?></option>
                            ...
                            <td class="d-none">
                                <select class="form-control disabled_or_not" name="standard_delivery" id="standard_delivery">
                                    <?php $__currentLoopData = $all_lengths; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $length): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($length->length); ?>" <?php echo e($project_details->standard_delivery ===  $length->length ? 'selected' : ''); ?>><?php echo e($length->length); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </td>
                            <td class="d-none">
                                <select class="form-control disabled_or_not" name="premium_delivery" id="premium_delivery">
                                    <?php $__currentLoopData = $all_lengths; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $length): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($length->length); ?>" <?php echo e($project_details->premium_delivery ===  $length->length ? 'selected' : ''); ?>><?php echo e($length->length); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </td>
                        <?php else: ?>
                    ...
                    <?php $__currentLoopData = $project_details->project_attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                    <tr class="append-include append-remove d-none">
                        <th>
                            <div class="package-head-left">
                                ...
                                <div class="package-field">
                                    <div class="package-field-select">
                                        <select class="form-control checkbox_or_numeric_select" name="checkbox_or_numeric_select[]">
                                            ...
                                            <option value="text" <?php if($attr->type == 'text'): ?> selected <?php endif; ?>><?php echo e(__('Text Field')); ?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <td>
                            <div class="d-flex flex-column gap-1">
                                <?php if($attr->type == 'checkbox'): ?>
                                    <input name="<?php echo e($attr_value); ?>[basic]" type="checkbox" class="check-input" <?php if($attr->basic_check_numeric == 'on'): ?> checked <?php endif; ?>>
                                <?php elseif($attr->type == 'numeric'): ?>
                                    <input name="<?php echo e($attr_value); ?>[basic]" type="number" class="form-control" value="<?php echo e($attr->basic_check_numeric); ?>">
                                <?php elseif($attr->type == 'text'): ?>
                                    <input name="<?php echo e($attr_value); ?>[basic]" type="text" class="form-control text-input" maxlength="60" value="<?php echo e($attr->basic_check_numeric); ?>">
                                    <div class="char-counter"><?php echo e(strlen($attr->basic_check_numeric)); ?>/60</div>
                                <?php endif; ?>

                                <input type="number" name="<?php echo e($attr_value); ?>[basic_price]" class="form-control price-input"
                                    placeholder="<?php echo e(__('Extra price')); ?>" min="0" value="<?php echo e($attr->basic_extra_price ?? ''); ?>">
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="d-flex flex-column gap-1">
                                <?php if($attr->type == 'checkbox'): ?>
                                    <input name="<?php echo e($attr_value); ?>[standard]" type="checkbox" class="check-input disabled_or_not" <?php if($attr->standard_check_numeric == 'on'): ?> checked <?php endif; ?>>
                                <?php elseif($attr->type == 'numeric'): ?>
                                    <input name="<?php echo e($attr_value); ?>[standard]" type="number" class="form-control disabled_or_not" value="<?php echo e($attr->standard_check_numeric); ?>">
                                <?php elseif($attr->type == 'text'): ?>
                                    <input name="<?php echo e($attr_value); ?>[standard]" type="text" class="form-control text-input disabled_or_not" maxlength="60" value="<?php echo e($attr->standard_check_numeric); ?>">
                                    <div class="char-counter"><?php echo e(strlen($attr->standard_check_numeric)); ?>/60</div>
                                <?php endif; ?>

                                <input type="number" name="<?php echo e($attr_value); ?>[standard_price]" class="form-control price-input"
                                    placeholder="<?php echo e(__('Extra price')); ?>" min="0" value="<?php echo e($attr->standard_extra_price ?? ''); ?>">
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="d-flex flex-column gap-1">
                                <?php if($attr->type == 'checkbox'): ?>
                                    <input name="<?php echo e($attr_value); ?>[premium]" type="checkbox" class="check-input disabled_or_not" <?php if($attr->premium_check_numeric == 'on'): ?> checked <?php endif; ?>>
                                <?php elseif($attr->type == 'numeric'): ?>
                                    <input name="<?php echo e($attr_value); ?>[premium]" type="number" class="form-control disabled_or_not" value="<?php echo e($attr->premium_check_numeric); ?>">
                                <?php elseif($attr->type == 'text'): ?>
                                    <input name="<?php echo e($attr_value); ?>[premium]" type="text" class="form-control text-input disabled_or_not" maxlength="60" value="<?php echo e($attr->premium_check_numeric); ?>">
                                    <div class="char-counter"><?php echo e(strlen($attr->premium_check_numeric)); ?>/60</div>
                                <?php endif; ?>

                                <input type="number" name="<?php echo e($attr_value); ?>[premium_price]" class="form-control price-input"
                                placeholder="<?php echo e(__('Extra price')); ?>" min="0" value="<?php echo e($attr->premium_extra_price ?? ''); ?>">
                                        ...
                                        <div class="package-field-price-main">
                                            <h5 class="package-field-price-main-title">
                                                <?php if(moduleExists('CurrencySwitcher')): ?>
                                                    <?php if($project_details->basic_discount_charge !== null && $project_details->basic_discount_charge>0): ?>
                                                        <span class="basic_discount_charge"><?php echo e(float_amount_without_currency_symbol($project_details->basic_discount_charge)); ?></span>
                                                        <span class="basic_regular_charge"><s><?php echo e(float_amount_without_currency_symbol($project_details->basic_regular_charge)); ?></s></span>
                                                    <?php else: ?>
                                                        <span class="basic_discount_charge"><?php echo e(float_amount_without_currency_symbol($project_details->basic_discount_charge)); ?></span>
                                                        <span class="basic_regular_charge"><?php echo e(float_amount_without_currency_symbol($project_details->basic_regular_charge)); ?></span>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                ...
                                <div class="package-field-price">
                                    <div class="package-field-price-flex flex-between">
                                        <div class="package-field-price-main">
                                            <h5 class="package-field-price-main-title">
                                                <?php if(moduleExists('CurrencySwitcher')): ?>
                                                    <?php if($project_details->standard_discount_charge !== null && $project_details->standard_discount_charge>0): ?>
                                                        <span class="standard_discount_charge"><?php echo e(float_amount_without_currency_symbol($project_details->standard_discount_charge,2)); ?></span>
                                                        <span class="standard_regular_charge"><s><?php echo e(float_amount_without_currency_symbol($project_details->standard_regular_charge,2)); ?></s></span>
                                                    <?php else: ?>
                                                        <span class="standard_discount_charge"><?php echo e(float_amount_without_currency_symbol($project_details->standard_discount_charge,2)); ?></span>
                                                        <span class="standard_regular_charge"><?php echo e(float_amount_without_currency_symbol($project_details->standard_regular_charge,2)); ?></span>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                ...
                                <div class="package-field-price">
                                    <div class="package-field-price-flex flex-between">
                                        <div class="package-field-price-main">
                                            <h5 class="package-field-price-main-title">
                                                <?php if(moduleExists('CurrencySwitcher')): ?>
                                                    <?php if($project_details->premium_discount_charge !== null && $project_details->premium_discount_charge>0): ?>
                                                        <span class="premium_discount_charge"><?php echo e(float_amount_without_currency_symbol($project_details->premium_discount_charge,2)); ?></span>
                                                        <span class="premium_regular_charge"><s><?php echo e(float_amount_without_currency_symbol($project_details->premium_regular_charge,2)); ?></s></span>
                                                    <?php else: ?>
                                                        <span class="premium_discount_charge"><?php echo e(float_amount_without_currency_symbol($project_details->premium_discount_charge,2)); ?></span>
                                                        <span class="premium_regular_charge"><?php echo e(float_amount_without_currency_symbol($project_details->premium_regular_charge)); ?></span>
                                                    <?php endif; ?>
                                                <?php else: ?>
    ...
    <div class="popup-contents">
        ...
        <div class="popup-contents-form custom-form">
            <div class="single-input single-input-icon">
                ...
                <input type="text" name="basic_regular_charge" id="basic_regular_charge" class="form--control" placeholder="00" value="<?php echo e(float_amount_without_currency_symbol($project_details->basic_regular_charge)); ?>">
                <?php if(moduleExists('CurrencySwitcher')): ?>
            ...
            <div class="single-input single-input-icon">
                ...
                <input type="text" name="basic_discount_charge" id="basic_discount_charge" class="form--control" placeholder="00" value="<?php echo e(float_amount_without_currency_symbol($project_details->basic_discount_charge)); ?>">
                <?php if(moduleExists('CurrencySwitcher')): ?>
                    <span class="input-icon"><?php echo e(site_currency_symbol()); ?></span>
                <?php else: ?>
                    <span class="input-icon"><?php echo e(get_static_option('site_global_currency') ?? ''); ?></span>
...
<div class="popup-fixed price-popup-standard-charge">
    <div class="popup-contents">
        ...
        <div class="popup-contents-form custom-form">
            <div class="single-input single-input-icon">
                <label class="label-title"> <?php echo e(__('Regular Charge')); ?> </label>
                <input type="text" name="standard_regular_charge" id="standard_regular_charge" class="form--control" placeholder="00" value="<?php echo e(float_amount_without_currency_symbol($project_details->standard_regular_charge) ?? ''); ?>">
                <?php if(moduleExists('CurrencySwitcher')): ?>
                    <span class="input-icon"><?php echo e(site_currency_symbol()); ?></span>
                <?php else: ?>
                    <span class="input-icon"><?php echo e(get_static_option('site_global_currency') ?? ''); ?></span>
            ...
            <div class="single-input single-input-icon">
                <label class="label-title"> <?php echo e(__('Discount Charge(Optional)')); ?> </label>
                <input type="text" name="standard_discount_charge" id="standard_discount_charge" class="form--control" placeholder="00" value="<?php echo e(float_amount_without_currency_symbol($project_details->standard_discount_charge) ?? ''); ?>">
                <?php if(moduleExists('CurrencySwitcher')): ?>
                    <span class="input-icon"><?php echo e(site_currency_symbol()); ?></span>
                <?php else: ?>
                    <span class="input-icon"><?php echo e(get_static_option('site_global_currency') ?? ''); ?></span>
...
<div class="popup-fixed price-popup-premium-charge">
    <div class="popup-contents">
        ...
        <div class="popup-contents-form custom-form">
            <div class="single-input single-input-icon">
                <label class="label-title"><?php echo e(__('Regular Charge')); ?></label>
                <input type="text" name="premium_regular_charge" id="premium_regular_charge" class="form--control" placeholder="00" value="<?php echo e(float_amount_without_currency_symbol($project_details->premium_regular_charge) ?? ''); ?>">
                <?php if(moduleExists('CurrencySwitcher')): ?>
                    <span class="input-icon"><?php echo e(site_currency_symbol()); ?></span>
                <?php else: ?>
                    <span class="input-icon"><?php echo e(get_static_option('site_global_currency') ?? ''); ?></span>
            ...
            <div class="single-input single-input-icon">
                <label class="label-title"><?php echo e(__('Discount Charge(Optional)')); ?></label>
                <input type="text" name="premium_discount_charge" id="premium_discount_charge" class="form--control" placeholder="00" value="<?php echo e(float_amount_without_currency_symbol($project_details->premium_discount_charge) ?? ''); ?>">
                <?php if(moduleExists('CurrencySwitcher')): ?>
                    <span class="input-icon"><?php echo e(site_currency_symbol()); ?></span>
                <?php else: ?>
                    <span class="input-icon"><?php echo e(get_static_option('site_global_currency') ?? ''); ?></span>
...
<!-- Package & Charge Ends -->
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/freelancer/project/edit/project-package-charge.blade.php ENDPATH**/ ?>