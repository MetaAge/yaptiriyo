    ...
    <section class="bg-[#F8F9FD] py-10 md:py-16 lg:py-[120px]">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="relative px-0">
                <!-- Arrow left -->
                <button title="<?php echo e(__('Previous')); ?>" id="relatedPrevBtn"
                ...
                <!-- Arrow right -->
                <button title="<?php echo e(__('Next')); ?>" id="relatedNextBtn"
                        ...
                        <?php $__currentLoopData = $relatedProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedProject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="related-service-card bg-white rounded-2xl border overflow-hidden w-full max-w-[390px] flex-shrink-0">
                                <figure class="relative w-full px-4 pt-4">
                                                    ...
                                                    <div class="card-image-slide">
                                                        <?php if($isImage): ?>
                                                            <?php if(cloudStorageExist() && in_array(Storage::getDefaultDriver(), ['s3', 'cloudFlareR2', 'wasabi'])): ?>
                                                                <img src="<?php echo e(render_frontend_cloud_image_if_module_exists('project/'.$mediaFile, load_from: $relatedProject->load_from)); ?>"
                                            ...
                                            <?php if($hasMultipleMedia): ?>
                                                ...
                                                <div class="card-pagination-container">
                                                    <?php $__currentLoopData = $projectMedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dotIndex => $mediaFile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <button class="card-pagination-dot w-2 h-2 rounded-full transition-all <?php echo e($dotIndex === 0 ? 'active bg-white w-4' : 'bg-white/60'); ?>"
                                    ...
                                    <?php if(Auth::guard('web')->check()): ?>
                                        <?php if($bookmark_exists): ?>
                                            ...
                                            <button type="button"
                                                    ...
                                                    data-identity="<?php echo e($relatedProject->id); ?>"
                                                    data-type="project"
                                    ...
                                    <?php if(moduleExists('PromoteFreelancer') && $relatedProject->is_pro == 'yes' && $relatedProject->pro_expire_date >= now()): ?>
                                ...
                                <div class="p-4 space-y-3">
                                    <hgroup class="space-y-3">
                                        <div class="flex items-center justify-between">
                                            <p class="text-sm font-medium text-gray-500">
                                                <?php echo e($relatedProject->project_category->category ?? ''); ?>
                                        ...
                                        <a href="<?php echo e(route('project.details', ['username' => $relatedProject->project_creator->username ?? 'user', 'slug' => $relatedProject->slug])); ?>"
                                           class="block">
                                    ...
                                    <div class="flex items-center gap-1 text-yellow-500">
                                        ...
                                        <?php
                                            $avgRating = $relatedProject->average_rating ?? ($relatedProject->ratings->avg('rating') ?? 0);
                                            $formattedRating = number_format($avgRating, 1);
                                            $reviewCount = $relatedProject->ratings_count ?? $relatedProject->ratings->count();
                                        ?>
                                        <span class="text-sm font-semibold text-gray-700"><?php echo e($formattedRating); ?></span>
                                        <span class="text-sm text-gray-500">(<?php echo e($reviewCount); ?> <?php echo e($reviewCount == 1 ? 'Review' : 'Reviews'); ?>)</span>
                                    </div>
                                    <footer class="flex items-center justify-between pt-4 border-t border-gray-200">
                                        <div class="flex items-center gap-3">
                                            <?php if($relatedProject->project_creator && $relatedProject->project_creator->image): ?>
                                                <div class="relative w-10 h-10">
                                                    <?php if(cloudStorageExist() && in_array(Storage::getDefaultDriver(), ['s3', 'cloudFlareR2', 'wasabi'])): ?>
                                                        <img src="<?php echo e(render_frontend_cloud_image_if_module_exists('profile/'.$relatedProject->project_creator->image, load_from: $relatedProject->project_creator->load_from)); ?>"
                                                             alt="<?php echo e($relatedProject->project_creator->first_name); ?>"
                                                             class="w-full h-full rounded-full object-cover">
                                                    <?php else: ?>
                                                        <img src="<?php echo e(asset('assets/uploads/profile/' . $relatedProject->project_creator->image)); ?>"
                                                             alt="<?php echo e($relatedProject->project_creator->first_name); ?>"
                                                             class="w-full h-full rounded-full object-cover">
                                                    <?php endif; ?>
                                                </div>
                                            ...
                                            <span class="text-sm font-semibold text-gray-700">
                                                <?php echo e($relatedProject->project_creator->first_name ?? 'User'); ?>
...
<?php endif; ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/project-details/related-service.blade.php ENDPATH**/ ?>