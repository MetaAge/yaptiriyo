<?php $__env->startSection('title', __('Subscription Chat Settings')); ?>
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title"><?php echo e(__('Chat Enable Disable Settings')); ?></h4>
                        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.notice.general-notice','data' => ['class' => 'mt-5','description' => __('Notice: If you want to disable chat without active subscription keep this disable.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('mt-5'),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Notice: If you want to disable chat without active subscription keep this disable.'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            <form action="<?php echo e(route('admin.subscription.chat.enable.disable.settings')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="single-input my-5">
                                    <label class="label-title"><?php echo e(__('Enable/Disable Chat')); ?></label>
                                    <select name="subscription_chat_enable_disable" class="form-control">
                                        <option value=""><?php echo e(__('Enable-Disable')); ?></option>
                                        <option value="enable" <?php if(get_static_option('subscription_chat_enable_disable') == 'enable'): ?> selected <?php endif; ?>><?php echo e(__('Enable')); ?></option>
                                        <option value="disable" <?php if(get_static_option('subscription_chat_enable_disable') == 'disable'): ?> selected <?php endif; ?>><?php echo e(__('Disabled')); ?></option>
                                    </select>
                                </div>
...
<?php echo $__env->make('backend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/Modules/Subscription/Resources/views/backend/settings/subscription-chat-enable-disable.blade.php ENDPATH**/ ?>