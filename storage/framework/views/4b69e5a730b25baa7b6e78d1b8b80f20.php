            ...
            $(document).ready(function () {
                ...
                $(document).on('click', '.click_to_bookmark', function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            if (res.status === 'success') {
                                toastr_success_js('<?php echo e(__('Bookmark added successfully')); ?>');
                        ...
                        error: function(xhr) {
                            ...
                            toastr_error_js('<?php echo e(__('Failed to add bookmark')); ?>');
                        }
                    });
                });
                ...
                $(document).on('click', '.remove_from_bookmark', function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            if (res.status === 'success') {
                                toastr_success_js('<?php echo e(__('Bookmark removed successfully')); ?>');
                                location.reload();
                            }
                        },
                        error: function(xhr) {
                            console.error('Remove bookmark error:', xhr);
                            toastr_error_js('<?php echo e(__('Failed to remove bookmark')); ?>');
                        }
                    });
                });
...
</script><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/category-projects/category-project-filter-js.blade.php ENDPATH**/ ?>