...
<?php endif; ?>
                            ...
                            <form class="login-wrapper-contents-form custom-form signup-forms" method="post" action="<?php echo e(route('client._2fa.verify.code')); ?>">
                                <?php echo csrf_field(); ?>
                    ...
                    $.ajax({
                        ...
                        success:function (data){
                            ...
                            if (data.status == 'client-login'){
                                ...
                                let redirectPath = "<?php echo e(route('client.profile')); ?>";
                                ...
                                el.text('<?php echo e(__('Redirecting')); ?>..');
                                erContainer.html('<div class="alert alert-'+data.type+'">'+data.msg+'</div>');
                                let redirectPath = "<?php echo e(route('freelancer.profile')); ?>";
...
<?php echo $__env->make('frontend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/client/_2fa/-2fa-verify-code.blade.php ENDPATH**/ ?>