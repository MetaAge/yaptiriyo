    ...
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            $(document).on('click','.contact_warning_chat_message',function(){
                toastr.warning("<?php echo e(__('Please login as a client to chat with freelancer.')); ?>");
                return false;
            });
            ...
            $(document).on('change', '#earningToggle', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('freelancer.toggle.earning')); ?>",
                    method: 'POST',
                    data: {
                    ...
                    success: function(response) {
                        if (response.status === 'success') {
                            ...
                            if (isChecked) {
                                $toggleLabel.html('<span class="text-green-600"><i class="fas fa-eye mr-1"></i> <?php echo e(__("Earnings are Visible")); ?></span>');
                                $toggleInfo.text('<?php echo e(__("Clients can see your total earnings")); ?>');
                                // Toggle is ON - move slider to right
                                $toggleSlider.addClass('toggle-on').removeClass('toggle-off');
                            } else {
                                $toggleLabel.html('<span class="text-gray-600"><i class="fas fa-eye-slash mr-1"></i> <?php echo e(__("Earnings are Hidden")); ?></span>');
                                $toggleInfo.text('<?php echo e(__("Clients cannot see your earnings")); ?>');
                        ...
                        $.ajax({
                            ...
                            success:function(res){
                                if(res.status == 'success'){
                                    ...
                                    toastr.success("<?php echo e(__('Work Availability Status Successfully Changed')); ?>")
                                }
                            }
                        })
                    }
            ...
            $(document).on('click','.edit_public_profile_info',function(e){
                ...
                if(first_name == '' || last_name =='' || title == '' || description == '' || country_id==''){
                    toastr.warning("<?php echo e(__('Please fill all fields.')); ?>")
                    return false;
                }else{
                    $.ajax({
                        ...
                        success:function(res){
                            if(res.status=='success'){
                                ...
                                toastr.success("<?php echo e(__('Profile Info Successfully Updated')); ?>")
                            }
                        },
                        error:function(err){
            ...
            $(document).on('click','.edit_public_hourly_rate',function(e){
                ...
                if(hourly_rate == ''){
                    toastr.warning("<?php echo e(__('price is required.')); ?>")
                    return false;
                }else{
                    $.ajax({
                        ...
                        success:function(res){
                            if(res.status=='success'){
                                ...
                                toastr.success("<?php echo e(__('Price Successfully Updated')); ?>")
                            }
                        },
                        error:function(err){
                            let error = err.responseJSON;
            ...
            $(document).on('submit','#add_portfolio_form',function(e){
                ...
                if(image == '' || title == '' || description == ''){
                    toastr.warning("<?php echo e(__('Image, title and description fields are require')); ?>")
                    return false;
                }else{
                    ...
                    $.ajax({
                        ...
                        success:function(res){
                            if(res.status=='success'){
                                ...
                                toastr.success("<?php echo e(__('Portfolio Successfully Added')); ?>")
                            }
                            if(res.status == 'error') {
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            if(res.status=='success'){
                                ...
                                $('.portfolio_details_display').load(location.href + ' .portfolio_details_display');
                                toastr.success("<?php echo e(__('Portfolio Successfully Updated')); ?>")
                            }
                        },
                        error: function (err) {
                            let error = err.responseJSON;
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success:function(res){
                                if(res.status == 'success'){
                                    $('.portfolio_details_display').load(location.href + ' .portfolio_details_display');
                                    toastr.success("<?php echo e(__('Portfolio Successfully Deleted')); ?>")
                                }
                            }
                        })
                    }
                        ...
                        $.ajax({
                            ...
                            success:function(res){
                                if(res.status == 'success'){
                                    ...
                                    toastr.success("<?php echo e(__('Project Successfully Deleted')); ?>")
                                }
                            }
                        })
                    }
            ...
            $(document).on('click','.update_freelancer_skill',function(){
                ...
                $.ajax({
                    ...
                    success: function(res){
                        if(res.status == 'ok'){
                            toastr.success("<?php echo e(__('Skill Successfully Updated')); ?>");
                            $('.edit_skill_wrapper').hide();
                    ...
                    $.ajax({
                        ...
                        success: function(res){
                            if(res.status == 'ok'){
                                ...
                                toastr.success("<?php echo e(__('Education Successfully Added')); ?>");
                            }
                        }
                    });
                }
            ...
            $(document).on('click','.update_single_education',function(){
                ...
                if(institution == '' || subject == '' || degree == '' || start_date == '' || end_date == ''){
                    ...
                    $.ajax({
                        ...
                        success: function(res){
                            if(res.status == 'ok'){
                                toastr.success("<?php echo e(__('Education Successfully Updated')); ?>");
                                $('.popup-fixed, .popup-overlay').removeClass('popup-active');
                                $('#display_user_education_data').load(location.href + " #display_user_education_data");
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success:function(res){
                                if(res.status == 'success'){
                                    $('#display_user_education_data').load(location.href + ' #display_user_education_data');
                                    toastr.success("<?php echo e(__('Education Successfully Deleted')); ?>")
                                }
                            }
                        })
                    }
            ...
            $(document).on('click','.add_experience',function(){
                ...
                if(end_date != '' && start_date >end_date){
                    toastr.warning("<?php echo e(__('Start date must not greater than end date !')); ?>");
                    return false;
                }else{
                    $.ajax({
                        ...
                        success: function(res){
                            if(res.status == 'ok'){
                                ...
                                $(addExperienceForm)[0].reset();
                                toastr.success("<?php echo e(__('Experience Successfully Added')); ?>");
                            }
                        }
                    });
                }
                    ...
                    $.ajax({
                        ...
                        success: function(res){
                            if(res.status == 'ok'){
                                ...
                                $('#display_user_experience_data').load(location.href + " #display_user_experience_data");
                                $(addExperienceForm)[0].reset();
                                toastr.success("<?php echo e(__('Experience Successfully Updated')); ?>");
                            }
                        }
                    });
                }
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success:function(res){
                                if(res.status == 'success'){
                                    $('#display_user_experience_data').load(location.href + ' #display_user_experience_data');
                                    toastr.success("<?php echo e(__('Experience Successfully Deleted')); ?>")
                                }
                            }
                        })
                    }
                        ...
                        $.ajax({
                            ...
                            success:function(res){
                                if(res.status == 'success'){
                                    ...
                                    toastr.success("<?php echo e(__('Availability Status Successfully Changed')); ?>")
                                }
                            }
                        })
                    }
            ...
            $(document).on('click','.view_as_a_client',function(){
                $('.change_client_view').html('<a href="javascript:void(0)" class="px-4 text-primary border py-1 rounded-lg hover:text-primary/90 hover:border-primary transition mb-4 flex items-center justify-center gap-2 text-sm view_original"> <?php echo e(__('Exit View as Client')); ?> </a>')
            ...
            $(document).on('click','.view_original',function(){
                $('.change_client_view').html('<a href="javascript:void(0)" class="px-4 text-primary border py-1 rounded-lg hover:text-primary/90 hover:border-primary transition mb-4 flex items-center justify-center gap-2 text-sm view_as_a_client"> <?php echo e(__('View as Client')); ?> </a>')
            ...
            $(document).on('click','.confirm_promote_project',function(){
                ...
                if(package_budget == ''){
                    toastr.warning("<?php echo e(__('Please choose package plan')); ?>")
                    return false;
                }
                if(payment_gateway == 'manual_payment'){
                    if(manual_payment_image == ''){
                        toastr.warning("<?php echo e(__('Please choose image for manual payment.')); ?>")
                        return false;
                    }
                }
...
<script>
    $(document).ready(function() {
        ...
        $('#toggle-reviews-btn').on('click', function(e) {
            ...
            if ($hiddenReviews.length > 0) {
                ...
                $reviewsText.text('<?php echo e(__("Show Less Reviews")); ?>');
                ...
                $reviewsText.text('<?php echo e(__("Show All Reviews")); ?>');
    ...
    $(document).on('click', '.delete-project-btn', function(e) {
        ...
        const deleteUrl = "<?php echo e(route('freelancer.project.delete')); ?>";
        const csrfToken = $('meta[name="csrf-token"]').attr('content');

        Swal.fire({
            title: '<?php echo e(__("Delete Project")); ?>',
            text: '<?php echo e(__("Are you sure you want to delete")); ?> "' + projectTitle + '"?',
            icon: 'warning',
            showCancelButton: true,
                    ...
                    success: function(response) {
                        if (response.status === 'success') {
                            ...
                            projectCard.fadeOut(300, function() {
                                ...
                                toastr.success('<?php echo e(__("Project deleted successfully")); ?>');
                            ...
                            toastr.error('<?php echo e(__("Failed to delete project")); ?>');
                        }
                    },
                    error: function(xhr) {
...
<script>
    ...
    function toggleClientView() {
        ...
        if (isClientView) {
            ...
            textSpan.textContent = '<?php echo e(__("Return to Freelancer View")); ?>';
            ...
            textSpan.textContent = '<?php echo e(__("View as Client")); ?>';
    ...
    function simulateLoggedOutContactMeButton() {
        ...
        if (contactBtn) {
            ...
            contactBtn.innerHTML = '<?php echo e(__("Login to Contact")); ?> <i class="fa-solid fa-arrow-right -rotate-45 text-sm ml-1"></i>';
    ...
    function restoreContactMeButton() {
        const contactBtn = document.getElementById('contact-me-btn');
        if (contactBtn && <?php echo json_encode(Auth::guard('web')->check(), 15, 512) ?>) {
            // Restore original contact button
            contactBtn.innerHTML = '<?php echo e(__("Contact me")); ?> <i class="fa-solid fa-arrow-right -rotate-45 text-sm ml-1"></i>';
            contactBtn.classList.remove('opacity-75');
            contactBtn.href = "<?php echo e(route('client.live.chat')); ?>?freelancer_id=<?php echo e($user->id); ?>";
        ...
        banner.innerHTML = `
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="font-semibold text-blue-800"><?php echo e(__('Viewing as Client')); ?></p>
                        <p class="text-sm text-blue-600"><?php echo e(__('All freelancer controls are now hidden')); ?></p>
                    </div>
                </div>
                <button onclick="toggleClientView()"
                        class="text-sm bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600 transition">
                    <?php echo e(__('Exit View')); ?>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status === 'success') {
                    ...
                    toastr.success('<?php echo e(__("Work availability updated successfully")); ?>');
                    ...
                    toastr.error(response.message || '<?php echo e(__("Failed to update")); ?>');
                }
            },
            error: function(xhr) {
...
</script><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/profile-details/profile-details-js.blade.php ENDPATH**/ ?>