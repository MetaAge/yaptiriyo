...
<?php endif; ?>
                            ...
                            <form class="login-wrapper-contents-form custom-form" id="user_auto_login_form" method="post"
                                ...
                                <button id="signin_form" class="submit-btn w-100 mt-4" type="submit">
                                    <?php echo e(get_static_option('login_page_button_title') ?? __('Sign In Now')); ?>

                                </button>
                                <span class="account color-light mt-3"><?php echo e(__("Don't have an account?")); ?> <a
                                        class="color-one" href="<?php echo e(route('user.register')); ?>">
                                        <?php echo e(__('SignUp Now')); ?></a></span>
                            </form>
                                        ...
                                        <tbody style="border-top: none;">
                                            <tr>
                                                ...
                                                <td><button type="button" class="autoLogin"
                                                        id="freelancerLogin"><?php echo e(__('Freelancer Login')); ?></button></td>
                                            </tr>
                                            <tr>
                        ...
                        <div class="login-right-item">
                            ...
                            <div class="login-right-contents text-white">
                                ...
                                <p class="login-right-contents-para">
                                    <?php echo e(get_static_option('login_page_sidebar_description') ?? __('Giriş yap, aradığın ustaya dakikalar içinde ulaş.')); ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content p-4">
                <h5 class="modal-title mb-3">
                    <?php echo e(get_static_option('register_page_choose_role_title') ?? __('Choose a Role')); ?>
                ...
                $('#signin_form').on('click', function(e) {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            redirect: redirectParam, // IMPORTANT: Send redirect to backend
                        },
                        error: function(data) {
                        ...
                        success: function(data) {
                            ...
                            if (data.status == 'client-login' || data.status == 'freelancer-login') {
                                ...
                                // Priority 1: Check if response has redirect_url
                                if (data.redirect_url) {
                                    redirectPath = data.redirect_url;
                                }
                                    // Priority 2: Check for return parameter
                                        <?php if(!empty(request()->get('return'))): ?>
                                else if ("<?php echo e(request()->get('return')); ?>" !== "") {
                                ...
                                // Priority 3: Default dashboard redirect
                                    ...
                                    if (data.status == 'client-login') {
                                        redirectPath = "<?php echo e(route('client.dashboard')); ?>";
                                    } else {
                                        redirectPath = "<?php echo e(route('freelancer.dashboard')); ?>";
                                    }
                                }
...
<?php echo $__env->make('frontend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/user-login.blade.php ENDPATH**/ ?>