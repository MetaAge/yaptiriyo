...
<?php else: ?>
    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            $rating =  \App\Models\Rating::select('id','order_id','rating')->where('order_id',$order->id)->where('sender_type',1)->first();
            $freelancerRating = \App\Models\Rating::where('order_id', $order->id)
                        ->where('sender_type', 2)
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.order.profile-image','data' => ['image' => $order?->user->image,'loadFrom' => $order?->user->load_from]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                        ...
                        <?php if($order->status == 3): ?>
                            <?php if($order?->freelancer?->is_suspend !=1): ?>
                                ...
                                <?php if(!$freelancerRating): ?>
                                    <a href="<?php echo e(route('freelancer.order.rating',$order->id)); ?>" class="btn-profile btn-outline-gray">
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/freelancer/order/search-result.blade.php ENDPATH**/ ?>