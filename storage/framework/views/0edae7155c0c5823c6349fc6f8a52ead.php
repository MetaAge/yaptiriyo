    ...
    <div class="w-80 bg-white rounded-lg shadow-lg border border-gray-200 p-6 h-screen overflow-y-auto fixed left-0 top-0 custom-scrollbar overflow-hidden">
        ...
        <div class="mb-8">
            ...
            <div class="relative">
                ...
                <input type="text" id="project_search_string" placeholder="<?php echo e(__('e.g. Adobe photoshop')); ?>"
        ...
        <!-- City/District -->
        <div class="mb-8">
            <label class="block text-lg font-medium mb-4 text-base-300 text-black/80"><?php echo e(__('City/District')); ?></label>
            <select id="city" class="my-select custom-select w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:border-primary bg-white">
...
</div><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/projects/sidebar.blade.php ENDPATH**/ ?>