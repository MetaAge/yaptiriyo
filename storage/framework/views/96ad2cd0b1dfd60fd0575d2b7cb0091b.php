    ...
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            function filterJobs() {
                ...
                let filterData = {
                    category: $('#category').val() || $('#category_id').val(), // Use hidden field for category ID
            ...
            function loadPaginationContent(url) {
                ...
                let filterData = {
                    category: $('#category').val() || $('#category_id').val(),
                    subcategory: $('#subcategory').val() ? [$('#subcategory').val()] : [],
                    country: $('#country').val(),
                    state: $('#state').val() ? [$('#state').val()] : [],
                    skills: $('#skills').val() ? [$('#skills').val()] : [],
            ...
            function updateActiveFilters() {
                ...
                // Don't include the main category as a filter (it's the page context)
                // Only show actual user-applied filters
            ...
            function initializePriceRangeSlider() {
                ...
                const MIN_VALUE = 0;
                const MAX_VALUE = window.maxJobPrice || 1000;
            ...
            function updateJobCountFromDOM() {
                ...
                if (jobCards > 0) {
                    $('.job-count-display').html('Showing ' + jobCards + ' out of ' + jobCards + ' results');
                }
            }
...
</script><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/category-jobs/jobs-filter-js.blade.php ENDPATH**/ ?>