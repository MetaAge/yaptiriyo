<?php $__env->startSection('site_title', $category->category . ' ' . __('Jobs')); ?>
<?php $__env->startSection('meta_title'); ?><?php echo e($category->category . ' ' . __('Jobs')); ?><?php $__env->stopSection(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb.user-profile-breadcrumb-02','data' => ['innerTitle' => $category->category . ' ' . __('Jobs'),'breadcrumbTitle' => $category->category]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['innerTitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($category->category . ' ' . __('Jobs')),'breadcrumbTitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($category->category)]); ?>
...
<?php endif; ?>
        ...
        <section class="bg-[#F8F9FD]">
            <div class="max-w-7xl mx-auto px-6 py-8 md:py-12 lg:py-16">
                <div class="mb-8">
                    <h1 class="text-3xl font-medium mb-2"><?php echo e($category->category); ?> <?php echo e(__('Jobs')); ?></h1>
                    <p class="text-gray-600"><?php echo e(__('Browse all available')); ?> <?php echo e(strtolower($category->category)); ?> <?php echo e(__('projects')); ?></p>
                </div>
                ...
                <div class="search_job_result">
                    <?php echo $__env->make('frontend.pages.category-jobs.search-job-result', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>

                <!-- Sidebar Filter -->
                <?php echo $__env->make('frontend.pages.category-jobs.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </section>
    </main>
...
<?php $__env->startPush('page_scripts'); ?>
    <script>
        window.routes = {
            ...
            jobsFilter: "<?php echo e(route('category.jobs.filter')); ?>",
            jobsPagination: "<?php echo e(route('category.jobs.pagination')); ?>",
            jobsFilterReset: "<?php echo e(route('category.jobs.filter.reset')); ?>"
        };
        window.csrfToken = "<?php echo e(csrf_token()); ?>";
        window.maxJobPrice = <?php echo e($maxJobPrice ?? 1000); ?>;
    </script>

    <?php echo $__env->make('frontend.pages.category-jobs.jobs-filter-js', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.new_design.layout.new_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/category-jobs/jobs.blade.php ENDPATH**/ ?>