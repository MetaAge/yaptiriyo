<?php $__env->startSection('site_title', __('Edit Job')); ?>
...
<?php endif; ?>
    <style>
        ...
        .country-selection-wrapper .text-success {
            font-size: 0.875em;
        }

        .country-selection-wrapper .text-danger {
            font-size: 0.875em;
        }

        .country-preview .alert {
            margin-bottom: 0;
        }
    </style>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb.user-profile-breadcrumb','data' => ['title' => __('Edit Job'),'innerTitle' => __('Edit Job')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Edit Job')),'innerTitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Edit Job'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        <form action="<?php echo e(route('client.job.edit', $job_details->id)); ?>" method="post"
                            enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php echo $__env->make('frontend.user.client.job.edit.job-details', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php echo $__env->make('frontend.user.client.job.edit.job-budget', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php echo $__env->make('frontend.user.client.job.edit.job-footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </form>
                    </div>
                </div>
            </div>
...
<?php $__env->startSection('script'); ?>
    <?php echo $__env->make('frontend.user.client.job.edit.edit-job-js', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            onKeyup: function(e) {
                setTimeout(function() {
                    ...
                    if (job_description_length < description_min_length) {
                        $('#job_description_char_length_check').html(
                            '<p class="text text-danger"><?php echo e(__('Length is short, minimum ')); ?>' +
                            description_min_length + ' <?php echo e(__('required')); ?>.</p>');
                    } else {
                        $('#job_description_char_length_check').html(
                            '<p class="text text-success"><?php echo e(__('Length is valid')); ?></p>');
                    }
                }, 200);
            }
        })
...
<?php echo $__env->make('frontend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/user/client/job/edit/edit-job.blade.php ENDPATH**/ ?>