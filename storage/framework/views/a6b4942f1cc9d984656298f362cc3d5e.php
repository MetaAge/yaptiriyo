        ...
        <div class="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow duration-300">
            <div class="flex justify-between items-start mb-4">
                ...
                <?php if($job->created_at->diffInHours(now()) < 24): ?>
                    <span class="bg-secondary text-white text-xs px-3 py-1 rounded-md"><?php echo e(__('New')); ?></span>
                <?php endif; ?>
            </div>
...
<?php endif; ?><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/category-jobs/search-job-result.blade.php ENDPATH**/ ?>