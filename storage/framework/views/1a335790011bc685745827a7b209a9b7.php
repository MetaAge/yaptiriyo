...
<div id="sidebar" class="fixed inset-0 bg-black/40 z-[9999] hidden ">
    <div class="w-80 bg-white rounded-lg shadow-lg border border-gray-200 p-6 h-screen overflow-y-auto fixed left-0 top-0 custom-scrollbar">
        ...
        <!-- Subcategories (since we're already in a category) -->
        <div class="mb-8">
        ...
        <div class="mb-8">
            ...
            <select id="country" class="my-select w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:border-primary bg-white">
...
</div><?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/category-jobs/sidebar.blade.php ENDPATH**/ ?>