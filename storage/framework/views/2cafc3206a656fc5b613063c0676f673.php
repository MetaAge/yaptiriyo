...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.bookmark','data' => ['identity' => $job->id,'type' => 'job']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                        ...
                        <ul class="categoryWrap-wrapper-item-bottom-list">
                            ...
                            <?php if($job->type == 'hourly'): ?>
                                ...
                                <span class="item-icon">
                                    ...
                                    <span class="item-para"><?php echo e(__('Estimated Hours:')); ?> <?php echo e($job->estimated_hours ?? ''); ?></span>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </div>
...
<?php endif; ?>
<?php /**PATH /Users/ahmetsahin/Desktop/xilancer/core/resources/views/frontend/pages/subcategory-jobs/search-job-result.blade.php ENDPATH**/ ?>