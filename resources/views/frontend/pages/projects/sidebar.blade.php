    ...
    <div class="w-80 bg-white rounded-lg shadow-lg border border-gray-200 p-6 h-screen overflow-y-auto fixed left-0 top-0 custom-scrollbar overflow-hidden">
        ...
        <div class="mb-8">
            ...
            <div class="relative">
                ...
                <input type="text" id="project_search_string" placeholder="{{ __('e.g. Adobe photoshop') }}"
        ...
        <!-- City/District -->
        <div class="mb-8">
            <label class="block text-lg font-medium mb-4 text-base-300 text-black/80">{{ __('City/District') }}</label>
