                    ...
                    <tr class="append-include append-remove d-none">
                        ...
                        <td>
                            <div class="d-flex flex-column gap-1">
                                ...
                                <input type="number" name="{{ $attr_value }}[basic_price]" class="form-control price-input"
                                    placeholder="{{ __('Extra price') }}" min="0" value="{{ $attr->basic_extra_price ?? '' }}">
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="d-flex flex-column gap-1">
                                ...
                                <input type="number" name="{{ $attr_value }}[standard_price]" class="form-control price-input"
                                    placeholder="{{ __('Extra price') }}" min="0" value="{{ $attr->standard_extra_price ?? '' }}">
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="d-flex flex-column gap-1">
                                ...
                                <input type="number" name="{{ $attr_value }}[premium_price]" class="form-control price-input"
                                placeholder="{{ __('Extra price') }}" min="0" value="{{ $attr->premium_extra_price ?? '' }}">
