                                                            ...
                                                            @if ($history->status === 0)
                                                                ...
                                                                @if (Auth::guard('web')->check() && Auth::guard('web')->user()->user_type == 1)
                                                                    ...
                                                                    <x-status.table.status-change :title="__('Accept Order')"
                                                                        :class="'btn-profile btn-bg-1 btn-small accept_and_pay'" :url="route(
                                    ...
                                    <div class="jobFilter-proposal-author-contents">
                                        ...
                                        <div class="jobFilter-proposal-author-contents-review mt-2">
                                            <span class="jobFilter-proposal-author-contents-review-star">
                                                ...
                                                {{ number_format($order_details->freelancer->freelancer_ratings_avg_rating ?? 0, 1) }}
                                                ({{ $order_details->freelancer->freelancer_ratings_count ?? 0 }})
                                            </span>
                                        </div>
                                    </div>
                                </div>
