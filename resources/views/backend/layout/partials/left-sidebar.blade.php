    ...
    <div class="dashboard__left__main">
        ...
        <div class="sidebar-search">
            <div class="search-input-wrapper">
                ...
                <input type="text" class="search-input" id="sidebar-search" placeholder="{{ __('Search menu...') }}" autocomplete="off">
            </div>
        </div>
        <div class="dashboard__bottom mt-3">
            ...
            <ul class="dashboard__bottom__list dashboard-list">
                ...
                <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.dashboard'])) active @endif">
                    <a href="{{ route('admin.dashboard') }}"> <i class="fa-solid fa-chart-simple"></i>{{ __('Dashboard') }}</a>
                </li>

                <!-- User Management -->
                <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/manage*') || request()->is('admin/role*') || (request()->is('admin/user*') && !request()->is('admin/user-report*')) || request()->is('admin/can-contact*')) active open show @endif">
                    <a href="javascript:void(0)"> <i class="fa-solid fa-users"></i> {{ __('User Management') }}</a>
                    <ul class="submenu">
                        @can('admin-role-manage')
                            <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/manage*') || request()->is('admin/role*')) active open show @endif">
                                <a href="javascript:void(0)"> <i class="fa-solid fa-user-shield"></i> {{ __('Admin Role Manage') }}</a>
                                <ul class="submenu">
                        ...
                        @endcan
                            ...
                            <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/user*') && !request()->is('admin/user-report*')) active open show @endif">
                            <a href="javascript:void(0)"> <i class="fa-solid fa-users-line"></i> {{ __('User Manage') }}</a>
                            <ul class="submenu">
                                @can('user-list')
                        ...
                        <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/can-contact*')) active open show @endif">
                            <a href="javascript:void(0)"> <i class="fa-solid fa-comments"></i> {{ __('User Chatting Access') }}</a>
                            <ul class="submenu">
                                @can('user-list')
                ...
                <!-- Location Management -->
                <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/location*')) active open show @endif">
                    <a href="javascript:void(0)"> <i class="fa-solid fa-earth-americas"></i> {{ __('Location Management') }}</a>
                    <ul class="submenu">
                        @can('country-list')
                ...
                <!-- Catalog Management -->
                <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/service*')) active open show @endif">
                    <a href="javascript:void(0)"> <i class="fa-solid fa-list"></i>{{ __('Catalog Management') }} </a>
                    <ul class="submenu">
                        @can('category-list')
                        ...
                        <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.category.empty.settings'])) selected @endif">
                            <a href="{{ route('admin.category.empty.settings') }}"> {{ __('Empty Category Settings') }} </a>
                        </li>
                    </ul>
                </li>

                <!-- Services & Projects -->
                <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/feedback*') || request()->is('admin/skill*') || request()->is('admin/length*') || request()->is('admin/experience*') || request()->is('admin/project*') || request()->is('admin/job*')) active open show @endif">
                    <a href="javascript:void(0)"> <i class="fa-solid fa-briefcase"></i>{{ __('Services & Projects') }}</a>
                    <ul class="submenu">
                        <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.feedback.all'])) active @endif">
                            <a href="{{ route('admin.feedback.all') }}"> <i class="fa-solid fa-comment-dots"></i>{{ __('Feedback Manage') }}</a>
                        </li>
                        ...
                        <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/project*')) active open show @endif">
                        ...
                        <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/job*')) active open show @endif">
                            ...
                            <ul class="submenu">
                                @can('job-auto-approval')
                                    <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.job.approval.settings'])) selected @endif">
                                        <a href="{{ route('admin.job.approval.settings') }}"> {{ __('Auto Approval Settings') }}</a>
                                    </li>
                                @endcan
                                <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.job.country.restriction.settings'])) selected @endif">
                                    <a href="{{ route('admin.job.country.restriction.settings') }}"> {{ __('Country Restriction Settings') }}</a>
                                </li>
                                @can('job-list')
                ...
                <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/wallet*') || request()->is('admin/withdraw*') || request()->is('admin/subscription*') || request()->is('admin/transaction*')) active open show @endif">
                    <a href="javascript:void(0)"> <i class="fa-solid fa-money-bill-wave"></i>{{ __('Financial Management') }}</a>
                    <ul class="submenu">
                        <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/wallet*')) active open show @endif">
                        ...
                        <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/withdraw*')) active open show @endif">
                            ...
                            <ul class="submenu">
                                @can('withdraw-settings-view')
                                    <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.wallet.withdraw.settings'])) selected @endif">
                                        <a href="{{ route('admin.wallet.withdraw.settings') }}"> {{ __('Withdraw Settings') }}</a>
                                    </li>
                                @endcan
                        ...
                        <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/subscription*')) active open show @endif">
                            <a href="javascript:void(0)"> <i class="fa-solid fa-credit-card"></i>{{ __('Subscription Manage') }}</a>
                            <ul class="submenu">
                        ...
                        @can('transaction-manage')
                            <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/transaction*')) active open show @endif">
                                <a href="javascript:void(0)"> <i class="fa-solid fa-file-invoice-dollar"></i>{{ __('Transaction Manage') }}</a>
                                <ul class="submenu">
                ...
                <!-- Order Management -->
                <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/order*') || request()->is('admin/user-report*')) active open show @endif">
                    <a href="javascript:void(0)"> <i class="fa-solid fa-cart-shopping"></i>{{ __('Order Management') }}</a>
                    <ul class="submenu">
                        @can('order-list')
                        ...
                        <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/user-report*')) active open show @endif">
                            <a href="javascript:void(0)"> <i class="fa-solid fa-flag"></i>{{ __('User Report Manage') }} </a>
                            <ul class="submenu">
                ...
                <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/newsletter*') || request()->is('admin/blog*') || request()->is('admin/support-ticket*') || request()->is('admin/notification*') || request()->routeIs(['admin.pusher.settings'])) active open show @endif">
                    ...
                    <ul class="submenu">
                        <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/newsletter*')) active open show @endif">
                            <a href="javascript:void(0)"> <i class="fa-solid fa-envelope-open-text"></i>{{ __('Newsletter Manage') }} </a>
                            <ul class="submenu">
                        ...
                        <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/support-ticket/*')) active open show @endif">
                            <a href="javascript:void(0)"> <i class="fa-solid fa-headset"></i>{{ __('Support') }} </a>
                            <ul class="submenu">
                                @can('department-list')
                        ...
                        <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/notification/*')) active open show @endif">
                            <a href="javascript:void(0)"> <i class="fa-solid fa-bell"></i>{{ __('Notifications') }} </a>
                            <ul class="submenu">
                                @can('notification-list')
                                    <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.notification.all'])) active @endif">
                                        <a href="{{ route('admin.notification.all') }}"> {{ __('All Notifications') }}</a>
                                    </li>
                                    <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.notification.settings'])) active @endif">
                                        <a href="{{ route('admin.notification.settings') }}"> {{ __('Notification Settings') }}</a>
                                    </li>
                                @endcan
                            </ul>
                        </li>
                        ...
                        <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.pusher.settings'])) active @endif">
                            <a href="{{ route('admin.pusher.settings') }}"> <i class="fa-regular fa-message"></i>{{ __('Chat Settings') }}</a>
                        </li>
                    </ul>
                </li>

                <!-- Site Settings -->
                <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/page-settings*') || request()->is('admin/general-settings*') || request()->is('admin/payment-settings*') || request()->is('admin/plugins*') || request()->is('admin/additional-settings*')) active open show @endif">
                    <a href="javascript:void(0)"> <i class="fa-solid fa-gear"></i> {{ __('Site Settings') }}</a>
                    <ul class="submenu">
                        <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/page-settings*')) active open show @endif">
                            <a href="javascript:void(0)"> <i class="fa-solid fa-file-lines"></i> {{ __('Page Settings') }} </a>
                            <ul class="submenu">
                                ...
                                <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/page-settings/account*')) active open show @endif">
                                    <a href="javascript:void(0)"> {{ __('Account Settings') }} </a>
                                    <ul class="submenu">
                                        @can('account-page-settings-view')
                                            <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.page.account.main.page'])) selected @endif">
                                                <a href="{{ route('admin.page.account.main.page') }}">
                                                    {{ __('Account Page Settings') }} </a>
                                            </li>
                                        @endcan
                                        @can('introduction-page-settings-view')
                                            <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.page.account.introduction'])) selected @endif">
                                                <a href="{{ route('admin.page.account.introduction') }}">
                                                    {{ __('Introduction Settings') }} </a>
                                            </li>
                                        @endcan
                                        @can('experience-page-settings-view')
                                            <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.page.account.experience'])) selected @endif">
                                                <a href="{{ route('admin.page.account.experience') }}">
                                                    {{ __('Experience Settings') }} </a>
                                            </li>
                                        @endcan
                                        @can('education-page-settings-view')
                                            <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.page.account.education'])) selected @endif">
                                                <a href="{{ route('admin.page.account.education') }}">
                                                    {{ __('Education Settings') }} </a>
                                            </li>
                                        @endcan
                                        @can('work-page-settings-view')
                                            <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.page.account.work'])) selected @endif">
                                                <a href="{{ route('admin.page.account.work') }}"> {{ __('Work Settings') }}</a>
                                            </li>
                                        @endcan
                                        @can('skill-page-settings-view')
                                            <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.page.account.skill'])) selected @endif">
                                                <a href="{{ route('admin.page.account.skill') }}"> {{ __('Skill Settings') }}</a>
                                            </li>
                                        @endcan
                                        @can('photo-page-settings-view')
                                            <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.page.account.rate.photo'])) selected @endif">
                        ...
                        <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/general-settings*')) active open show @endif">
                            <a href="javascript:void(0)"> <i class="fa-solid fa-sliders"></i> {{ __('General Settings') }}</a>
                            <ul class="submenu">
                                @can('reading')
                                ...
                                @can('social-login-settings')
                                    <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.general.settings.social.login'])) selected @endif">
                                        <a href="{{ route('admin.general.settings.social.login') }}"> {{ __('Social Login') }}</a>
                                    </li>
                                @endcan
                            ...
                            <ul class="submenu">
                                @can('payment-info-settings')
                                    <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.payment.settings.info'])) selected @endif">
                                        <a href="{{ route('admin.payment.settings.info') }}"> {{ __('Payment Info Settings') }}</a>
                                    </li>
                                @endcan
                        ...
                        <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/plugins*')) active open show @endif">
                            <a href="javascript:void(0)"> <i class="fa-solid fa-palette"></i> {{ __('Appearance Settings') }}</a>
                            <ul class="submenu">
                                @can('menu-list')
                        ...
                        <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/additional-settings*')) active open show @endif">
                            <a href="javascript:void(0)"> <i class="fa-solid fa-plus"></i>{{ __('Additional Settings') }}</a>
                            <ul class="submenu">
                                ...
                                <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.Freelancer-earning.settings'])) selected @endif">
                                    <a href="{{ route('admin.user.earning.toggle.settings') }}">
                                        {{ __('Freelancer Earning Hide/Show Settings') }} </a>
                                </li>
                                ...
                                <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.sticky.menu.settings'])) selected @endif">
                                ...
                                @endcan
                                <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.mobile.app.banner.settings'])) selected @endif">
                                    <a href="{{ route('admin.mobile.app.banner.settings') }}">
                                        {{ __('Banner Settings') }} </a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <!-- Content Management -->
                <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/email-template*') || request()->is('admin/dynamic-pages*') || request()->is(['admin/faq*']) || request()->is(['admin/languages*'])) active open show @endif">
                    <a href="javascript:void(0)"> <i class="fa-solid fa-file-lines"></i> {{ __('Content Management') }}</a>
                    <ul class="submenu">
                        <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/email-template*')) active open show @endif">
                            <a href="javascript:void(0)"> <i class="fa-solid fa-envelope"></i> {{ __('Email Template') }}</a>
                            <ul class="submenu">
                        ...
                        <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/dynamic-pages*')) active open show @endif">
                            <a href="javascript:void(0)"> <i class="fa-solid fa-file-circle-plus"></i> {{ __('Pages') }}</a>
                            <ul class="submenu">
                                @can('page-list')
                                ...
                                @can('manage-maintenance-page')
                                    <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.page.maintenance'])) selected @endif">
                                        <a href="{{ route('admin.page.maintenance') }}"> {{ __('Manage Maintenance Page') }}</a>
                                    </li>
                                @endcan
                            </ul>
                        </li>
                        ...
                        <li class="dashboard__bottom__list__item @if (request()->is(['admin/faq*'])) active @endif">
                            <a href="{{ route('admin.faq.all') }}"> <i class="fa-solid fa-question"></i>{{ __('Faq') }}</a>
                        </li>
                        
                        @can('language-list')
                            <li class="dashboard__bottom__list__item @if (request()->is(['admin/languages*'])) active @endif">
                                <a href="{{ route('admin.languages') }}"> <i class="fa-solid fa-language"></i>{{ __('Languages') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
                ...
                <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.integration'])) active @endif">
                    <a href="{{ route('admin.integration') }}"> <i class="fa-solid fa-plug"></i>{{ __('Integrations') }}</a>
                </li>
                ...
                @if(moduleExists('PluginManage'))
                    <li class="dashboard__bottom__list__item has-children @if (request()->is('admin/plugin-manage*')) active open @endif">
                        <a href="javascript:void(0)"> <i class="fa-solid fa-puzzle-piece"></i> {{ __('Plugin Manage') }} </a>
                        <ul class="submenu">
