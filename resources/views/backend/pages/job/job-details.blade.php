                                        ...
                                        <div class="tab-content-item dashboard-tab-content-item active" id="basic">
                                            ...
                                            <div class="project-preview-tab-inner mt-4">
                                                ...
                                                <div class="project-preview-tab-inner-item">
                                                    ...
                                                    {{-- Country Restriction Information --}}
                                                    @if($job->country_restriction_type && $job->country_restriction_type != 'none')
                                                        <div class="project-preview-tab-inner-item">
                                                            <span class="left">{{ __('Country Restriction') }}</span>
                                                            <span class="check-icon">
                                                                @if($job->country_restriction_type == 'include')
                                                                    <span class="badge bg-success">{{ __('Only Allowed') }}</span>
                                                                @elseif($job->country_restriction_type == 'exclude')
                                                                    <span class="badge bg-warning">{{ __('Excluded') }}</span>
                                                                @endif
                                                           </span>
                                                        </div>
                                                    @endif
                                                    @if(!empty($allowed_countries) && count($allowed_countries) > 0)
                                                        <div class="project-preview-tab-inner-item">
                                                            <span class="left">{{ __('Allowed Countries') }}</span>
                                                            <span class="check-icon">
                                                                @foreach($allowed_countries as $country)
                                                                    <span class="badge bg-success me-1 mb-1">{{ $country }}</span>
                                                                @endforeach
                                                                </span>
                                                                 </div>
                                                               @endif
                                                    @if(!empty($excluded_countries) && count($excluded_countries) > 0)
                                                        <div class="project-preview-tab-inner-item">
                                                            <span class="left">{{ __('Excluded Countries') }}</span>
                                                            <span class="check-icon">
                                                            @foreach($excluded_countries as $country)
                                                                    <span class="badge bg-danger me-1 mb-1">{{ $country }}</span>
                                                                @endforeach
                                                          </span>
                                                        </div>
                                                    @endif
