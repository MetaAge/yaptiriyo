                    ...
                    <div class="customMarkup__single__item">
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            ...
                            <form action="{{route('admin.subscription.add')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <x-form.text :title="__('Connect')" :type="__('number')" :name="'limit'" :id="'limit'" :divClass="'mb-3'" :value="old('limit', '')" :placeholder="__('Enter limit')"/>
                                <x-form.text :title="__('Apple Product ID')" :type="__('text')" :name="'apple_product_id'" :id="'apple_product_id'" :value="old('apple_product_id', '')" :placeholder="__('Enter Apple Product ID')"/>
                                <x-form.text :title="__('Google Product ID')" :type="__('text')" :name="'google_product_id'" :id="'google_product_id'" :divClass="'mb-0'" :value="old('google_product_id', '')" :placeholder="__('Enter Google Product ID')"/>
