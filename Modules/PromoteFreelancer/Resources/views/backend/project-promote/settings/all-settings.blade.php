                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title">{{ __('All Packages') }}</h4>
                            <x-btn.add-modal :title="__('All Packages')" />
                        </div>
                        <div class="customMarkup__single__inner mt-4">
                            <x-notice.general-notice :class="'mb-5'" :description="__(
                                'Notice: Duration refers to the number of days a freelancer\'s project or profile will be displayed in the promotional area when they choose to promote projects or jobs.',
                            )" />
                            <!-- Table Start -->
