                            ...
                            <form action="{{route('admin.payment.settings.gateway')}}" method="POST"
                                ...
                                <div class="accordion-wrapper">
                                    <div id="accordion-payment">
                                            ...
                                            <div id="stripe_settings_content" class="collapse"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @if(moduleExists('StripeConnect'))
                                                        <div class="single-input mt-3">
                                                            <label for="stripe_connect_client_id"
                                                                class="label-title mt-3">{{__('Stripe Connect Client ID')}}</label>
                                                            <input type="text" name="stripe_connect_client_id"
                                                                id="stripe_connect_client_id"
                                                                value="{{get_static_option('stripe_connect_client_id')}}"
                                                                class="form-control">
                                                        </div>
                                                        <div class="single-input mt-3">
                                                            <label for="stripe_webhook_secret_main_account"
                                                                class="label-title mt-3">{{__('Stripe Webhook Secret For Main Account')}}</label>
                                                            <input type="text" name="stripe_webhook_secret_main_account"
                                                                id="stripe_webhook_secret_main_account"
                                                                value="{{get_static_option('stripe_webhook_secret_main_account')}}"
                                                                class="form-control">
                                                            <div class="payment-notice alert alert-warning mt-3">
                                                                <p class="d-flex align-items-center">
                                                                    {{ __("Main Account Webhook URL") }}:
                                                                    <span id="webhook-url" class="ms-2">{{ route('stripe.payment-transfer.webhook') }}</span>
                                                                ...
                                                                <p>
                                                                    {{ __("Events to listen:") }}
                                                                    <strong>{{ __('transfer.canceled, transfer.created, transfer.reversed') }}</strong>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="single-input mt-3">
                                                            <label for="stripe_webhook_secret_connected_account"
                                                                class="label-title mt-3">{{__('Stripe Webhook Secret For Connected Account')}}</label>
                                                            <input type="text" name="stripe_webhook_secret_connected_account"
                                                                id="stripe_webhook_secret_connected_account"
                                                                value="{{get_static_option('stripe_webhook_secret_connected_account')}}"
                                                                class="form-control">
                                                            <div class="payment-notice alert alert-warning mt-3">
                                                                <p class="d-flex align-items-center">
                                                                    {{ __("Connected Account Webhook URL") }}
                                                                    <span id="webhook-url-two" class="ms-2">
                                                                        {{ route('stripe.account-update.webhook') }}
                                                                    </span>
                                                                    <button type="button" class="btn btn-sm btn-light ms-2 copy-btn-two" title="Copy">
                                                                        <i class="fa fa-copy"></i>
                                                                    </button>
                                                                </p>
                                                                <p>
                                        ...
                                        @if(moduleExists("AirwallexGateway"))
                                            {{-- AirwallexGateway  --}}
                                            <div class="card">
                                                <div class="card-header" id="airwallex_pago_content">
                                                    <h5 class="mb-0">
                                                        <button class="btn btn-link" type="button"
                                                                data-bs-toggle="collapse"
                                                                data-bs-target="#airwallex_settings_content"
                                                                aria-expanded="false">
                                                            <span class="page-title"> {{__('Airwallex Settings')}}</span>
                                                        </button>
                                                    </h5>
                                                </div>

                                                <div id="airwallex_settings_content" class="collapse"
                                                     data-parent="#accordion-payment">
                                                    <div class="card-body">

                                                        <div class="switch">
                                                            <label class="label-title mt-3"><strong>{{__('Enable/Disable Airwallex')}}</strong></label>
                                                            <input class="custom-switch" type="checkbox"
                                                                   id="airwallex_gateway" name="airwallex_gateway"
                                                                   @if(!empty(get_static_option('airwallex_gateway'))) checked @endif>
                                                            <label class="switch-label"
                                                                   for="airwallex_gateway">{{__('Enable/Disable Airwallex')}}</label>
                                                        </div>
                                                        <div class="switch">
                                                            <label class="label-title mt-3"><strong>{{__('Enable/Disable Test Mode Airwallex')}}</strong></label>
                                                            <input class="custom-switch" type="checkbox"
                                                                   id="airwallex_test_mode" name="airwallex_test_mode"
                                                                   @if(!empty(get_static_option('airwallex_test_mode'))) checked @endif>
                                                            <label class="switch-label"
                                                                   for="airwallex_test_mode">{{__('Enable/Disable Test Mode Airwallex')}}</label>
                                                        </div>
                                                        <div class="single-input mt-3">
                                                            <x-backend.image :title="__('Airwallex Logo')"
                                                                             :name="'airwallex_preview_logo'"
                                                                             :dimentions="'160x50'"/>
                                                        </div>
                                                        <div class="single-input">
                                                            <label for="airwallex_client_id"
                                                                   class="label-title mt-3">{{__('Set Client ID')}}</label>
                                                            <input type="text" name="airwallex_client_id"
                                                                   value="{{get_static_option('airwallex_client_id')}}"
                                                                   class="form-control">
                                                        </div>
                                                        <div class="single-input">
                                                            <label for="airwallex_api_key"
                                                                   class="label-title mt-3">{{__('Set API Key')}}</label>
                                                            <input type="text" name="airwallex_api_key"
                                                                   value="{{get_static_option('airwallex_api_key')}}"
                                                                   class="form-control">
                                                        </div>
                                                        <div class="single-input">
                                                            <label for="airwallex_api_url"
                                                                   class="label-title mt-3">{{__('Set API URl')}}</label>
                                                            <input type="text" name="airwallex_api_url"
                                                                   value="{{get_static_option('airwallex_api_url')}}"
                                                                   class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            {{-- Cryptomus gateway  --}}
                                            <div class="card">
                                                <div class="card-header" id="cryptomus_pago_content">
                                                    <h5 class="mb-0">
                                                        <button class="btn btn-link" type="button"
                                                                data-bs-toggle="collapse"
                                                                data-bs-target="#cryptomus_settings_content"
                                                                aria-expanded="false">
                                                            <span class="page-title"> {{__('Cruptomus Settings')}}</span>
                                                        </button>
                                                    </h5>
                                                </div>

                                                <div id="cryptomus_settings_content" class="collapse"
                                                     data-parent="#accordion-payment">
                                                    <div class="card-body">

                                                        <div class="switch">
                                                            <label class="label-title mt-3"><strong>{{__('Enable/Disable Cryptomus')}}</strong></label>
                                                            <input class="custom-switch" type="checkbox"
                                                                   id="cryptomus_gateway" name="cryptomus_gateway"
                                                                   @if(!empty(get_static_option('cryptomus_gateway'))) checked @endif>
                                                            <label class="switch-label"
                                                                   for="cryptomus_gateway">{{__('Enable/Disable Cryptomus')}}</label>
                                                        </div>
                                                        <div class="switch">
                                                            <label class="label-title mt-3"><strong>{{__('Enable/Disable Test Mode Cryptomus')}}</strong></label>
                                                            <input class="custom-switch" type="checkbox"
                                                                   id="cryptomus_test_mode" name="cryptomus_test_mode"
                                                                   @if(!empty(get_static_option('cryptomus_test_mode'))) checked @endif>
                                                            <label class="switch-label" for="cryptomus_test_mode">{{__('Enable/Disable Test Mode Cryptomus')}}</label>
                                                        </div>
                                                        <div class="single-input mt-3">
                                                            <x-backend.image :title="__('Cryptomus Logo')"
                                                                             :name="'cryptomus_preview_logo'"
                                                                             :dimentions="'160x50'"/>
                                                        </div>
                                                        <div class="single-input">
                                                            <label for="cryptomus_api_key"
                                                                   class="label-title mt-3">{{__('Set API Key')}}</label>
                                                            <input type="text" name="cryptomus_api_key"
                                                                   value="{{get_static_option('cryptomus_api_key')}}"
                                                                   class="form-control">
                                                        </div>
                                                        <div class="single-input">
                                                            <label for="cryptomus_merchant_id"
                                                                   class="label-title mt-3">{{__('Set Merchant ID')}}</label>
                                                            <input type="text" name="cryptomus_merchant_id"
                                                                   value="{{get_static_option('cryptomus_merchant_id')}}"
                                                                   class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            {{-- Cryptomus gateway end --}}
                                        @endif
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="xendit_settings_content" class="collapse"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="switch">
                                                        <label class="label-title mt-3"><strong>{{__('Enable/Disable Xendit')}}</strong></label>
                                                        <input class="custom-switch" type="checkbox" id="xendit_gateway"
                                                               name="xendit_gateway"
                                                               @if(!empty(get_static_option('xendit_gateway'))) checked @endif>
                                                        <label class="switch-label"
                                                               for="xendit_gateway">{{__('Enable/Disable Xendit')}}</label>
                                                    </div>
                                                    <div class="switch">
                                                        <label class="label-title mt-3"><strong>{{__('Enable/Disable Test Mode Xendit')}}</strong></label>
                                                        <input class="custom-switch" type="checkbox"
                                                               id="xendit_test_mode" name="xendit_test_mode"
                                                               @if(!empty(get_static_option('xendit_test_mode'))) checked @endif>
                                                        <label class="switch-label"
                                                               for="xendit_test_mode">{{__('Enable/Disable Test Mode Xendit')}}</label>
                                                    </div>
                                                    <div class="single-input mt-3">
                                                        <x-backend.image :title="__('Xendit Logo')"
                                                    ...
                                                    <div class="single-input">
                                                        <label for="xendit_webhook_token"
                                                               class="label-title mt-3">{{__('Set Webhook Token')}}</label>
                                                        <input type="text" name="xendit_webhook_token"
                                                               value="{{get_static_option('xendit_webhook_token')}}"
                                                               class="form-control">
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        (function ($) {
            ...
            $(document).ready(function () {
                ...
                $(document).on('click', '.copy-btn-two', function () {
                    var url = $('#webhook-url-two').text();
                    var tempInput = $('<input>');
                    $('body').append(tempInput);
                    tempInput.val(url).select();
                    document.execCommand('copy');
