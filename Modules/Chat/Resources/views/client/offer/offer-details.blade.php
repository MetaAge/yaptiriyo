                    ...
                    <div class="col-lg-8">
                                ...
                                <div class="myOrder-single-flex">
                                    <div class="myOrder-single-content">
                                        ...
                                        <div class="myOrder-single-content-btn flex-btn mt-3">
                                            ...
                                            @elseif($offer_details->status == 2)
                                                <span class="job-progress danger-approval" style="background-color: #ff3b3b; color: #fff; padding: 4px 12px; border-radius: 5px;">{{ __('Rejected') }}</span>
                                            @else
                        ...
                        <div class="myOrder-single-item mt-4">
                            <div class="myOrder-single-flex flex-between">
                                ...
                                @elseif($offer_details->status == 2)
                                    <a href="javascript:void(0)" class="btn-profile btn-bg-danger" style="background-color: #ff3b3b; color: #fff;">{{ __('Rejected') }}</a>
                                @else
                                <div class="btn-wrapper flex-btn">
                                    ...
                                    <a href="javascript:void(0)"
                                        class="btn-profile btn-outline-danger reject_custom_offer"
                                        data-offer-id="{{ $offer_details->id }}"
                                        style="border: 1px solid #ff3b3b; color: #ff3b3b; padding: 10px 20px; border-radius: 5px;">{{ __('Reject Offer') }}
                                    </a>
                                </div>
                                <form action="{{ route('client.offer.reject') }}" method="POST" id="offer_reject_form" style="display: none">
                                    @csrf
