                                    ...
                                    <tbody>
                                        @foreach ($gateways as $gateway)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary btn-sm mb-2 update-gateway"
                                                    ...
                                                    <x-popup.delete-popup :title="__('Delete')" :class="'btn btn-danger btn-sm mb-2 swal_delete_button'" :url="route('admin.wallet.withdraw.gateway.delete',$gateway->id)"/>
                                                    <x-status.table.status-change :title="__('Status')" :class="'btn btn-info btn-sm mb-2 swal_status_change_button'" :url="route('admin.wallet.withdraw.gateway.status',$gateway->id)"/>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
