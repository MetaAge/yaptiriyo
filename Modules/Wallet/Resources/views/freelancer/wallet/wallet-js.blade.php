    ...
    (function($) {
        ...
        $(document).ready(function() {
            ...
            $(document).on("change", ".gateway-name", function() {
                ...
                JSON.parse($(this).find(":selected").attr("data-fields")).forEach(function(value,
                    index) {
                    let gateway_name = value.toLowerCase().replaceAll(" ", "_").replaceAll(
                        "-", "_");
            ...
            $(document).on('keyup', '#withdraw_request_amount', function() {
                ...
                withdraw_fee_amount = withdraw_fee_type == 'percentage' ? (amount * withdraw_fee /
                    100).toFixed(2) : withdraw_fee;
            ...
            $(document).on('click', '#download_report', function() {
                ...
                window.location.href = "{{ route('freelancer.wallet.download') }}" + "?type=" +
                    type;
            });
