(function ($) {
    ...
    $(document).ready(function () {
       ...
       */
        ...
        /*
        ====================================================
            Category Submenu Position js (Desktop hover only)
        ====================================================
        */
        ...
        if (!isTouchDevice) {
            ...
            $(document).on("mouseenter", ".categorySub-list-slide-list", function (e) {
                let $submenu = $(this).find(".categorySub-slide-submenu");
                let catOffset = $(this).offset().left;
                let submenuWidth = $submenu.outerWidth();
                let windowWidth = $(window).width();

                // Check if submenu would go off-screen on the right
                let leftPosition = catOffset;
                if ((catOffset + submenuWidth) > windowWidth) {
                    // Position from the right edge instead
                    leftPosition = windowWidth - submenuWidth - 20; // 20px margin from edge
                }
            ...
            $(document).on('mouseleave', '.categorySub-list-slide-list', function (e) {
                $(this).removeClass("open").find(".categorySub-slide-submenu").css({
                    "display": "none",
                    "visibility": "hidden",
                    "opacity": "0",
                });
        ...
        /*
        ====================================================
            Mobile Icon Click Handler (Mobile/Touch only)
        ====================================================
        */
        ...
        $(document).on("click", ".mobileIcon", function (e) {
            ...
            let parent = $(this).closest(".categorySub-list-slide-list");
            let submenu = parent.find(".categorySub-slide-submenu");

            // Close all other open submenus
            $('.categorySub-list-slide-list').not(parent).removeClass("open")
                .find(".categorySub-slide-submenu").stop(true, true).slideUp(250);
            ...
            if (parent.hasClass("open")) {
                ...
                let catOffset = parent.offset().left;
                let submenuWidth = submenu.outerWidth();
                let windowWidth = $(window).width();
        ...
        /*
        ====================================================
            Prevent parent link navigation when clicking icon
        ====================================================
        */

        $(document).on("click", ".categorySub-list-slide-link", function (e) {
            // If the click came from mobileIcon, prevent navigation
            if ($(e.target).hasClass('mobileIcon') || $(e.target).closest('.mobileIcon').length) {
                e.preventDefault();
                e.stopPropagation();
                return false;
            }
        ...
        */
        ...
        $(document).on('click', function (e) {
            // If click is outside the category area
            if (!$(e.target).closest('.categorySub-list-slide-list, .categoryAll-wrap, .categoryBtn').length) {
                $('.categorySub-list-slide-list.open').removeClass('open')
                    .find('.categorySub-slide-submenu').stop(true, true).slideUp(250);
            }
        });
        ...
        */
        ...
        $(window).on('resize orientationchange', function () {
            $('.categorySub-list-slide-list.open').removeClass('open')
                .find('.categorySub-slide-submenu').stop(true, true).slideUp(0);
        });
