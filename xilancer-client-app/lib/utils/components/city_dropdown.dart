...
class CityDropdown extends StatelessWidget {
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, s, child) => ValueListenableBuilder(
        ...
        builder: (context, c, child) => Column(
          ...
          children: [
            FieldLabel(label: label ?? LocalKeys.city),
            InkWell(
              onTap: () {
                if (s == null) {
                              ...
                              child: ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    if (cProvider.cityList.isEmpty &&
                                        cProvider.citySearchText.isEmpty) {
                                      // Still show all option
                                    } else if (cProvider.cityList.isEmpty) {
                                      return SizedBox(
                                    ...
                                    return InkWell(
                                      onTap: () {
                                        ...
                                        cityNotifier.value = currentElement;
                                        if (onChanged == null) {
                                          return;
                                        }
                                  ...
                                  itemCount: cProvider.cityLoading == true
                                      ...
                                      : (cProvider.cityList.isEmpty &&
                                              cProvider.citySearchText.isNotEmpty)
                                          ? 1
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    8.toWidth,
                    Text(
                      c?.name ?? hintText ?? LocalKeys.selectCity,
  ...
  tryToLoadMore(BuildContext context) {
    try {
      final cl = Provider.of<CityDropdownService>(context, listen: false);
