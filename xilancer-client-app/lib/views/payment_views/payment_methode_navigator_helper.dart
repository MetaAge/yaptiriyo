...
Future startPayment(BuildContext context,
  ...
  final dProvider = context.dProvider;
  ...
  if (selectedGateway.name.toLowerCase().contains('iyzico') ||
      selectedGateway.name.toLowerCase().contains('iyzipay')) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (BuildContext context) => IyzipayPayment(
          onSuccess: onSuccess,
          onFailed: onFailed,
          htmlContent: selectedGateway.clientSecret ?? "", // Backend sends Iyzico form HTML here
