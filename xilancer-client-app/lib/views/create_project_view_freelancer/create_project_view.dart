...
import 'components/create_project_timeline.dart';
import 'components/project_gallery.dart';
import 'components/project_package.dart';
import 'components/project_intro.dart';
import 'components/gig_score_bar.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
              cpv.id != null ? LocalKeys.editProject : LocalKeys.createProject),
        ),
        body: Column(
          children: [
