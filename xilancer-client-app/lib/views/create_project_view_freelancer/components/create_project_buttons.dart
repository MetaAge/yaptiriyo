...
import 'package:xilancer/views/create_project_view_freelancer/components/project_preview_page.dart';
      ...
      children: [
        ...
        if (lastPage) ...[
          ...
          Expanded(
            ...
            child: OutlinedButton(
              onPressed: () {
                context.toPage(const ProjectPreviewPage());
              },
              child: Text(LocalKeys.preview),
            ),
          ),
        ],
      ],
