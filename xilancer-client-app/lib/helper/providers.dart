...
import 'package:xilancer/services/promotion_packages_service.dart';
...
class Providers {
  static List<SingleChildWidget> providers = [
    ...
    ChangeNotifierProvider.value(value: UserModeService.instance),
    ...
    ChangeNotifierProvider(create: (context) => PromotionManageService()),
    ChangeNotifierProvider(create: (context) => PromotionPackagesService()),
    ...
    ChangeNotifierProvider(create: (context) => AgoraCallService()),
    ChangeNotifierProvider(create: (context) => IyzicoCardService()),
    ChangeNotifierProvider(create: (context) => UserAddressService()),
    ChangeNotifierProvider(create: (context) => PortfolioService()),
    ChangeNotifierProvider(create: (context) => AppStatusService()),
    ChangeNotifierProvider(create: (context) => IAPService()),
  ];
}
