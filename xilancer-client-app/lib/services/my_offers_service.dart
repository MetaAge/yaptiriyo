...
class MyOffersService with ChangeNotifier {
  ...
  Future<bool> rejectOffer(offerId) async {
    final url = AppUrls.offerRejectUrl;
    final data = {"offer_id": offerId.toString()};
    final responseData = await NetworkApiServices()
        .postApi(data, url, LocalKeys.reject, headers: acceptJsonAuthHeader);
